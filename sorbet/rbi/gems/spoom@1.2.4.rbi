...
class Spoom::BacktraceFilter::Minitest < ::Minitest::BacktraceFilter
  # source://spoom/lib/spoom/backtrace_filter/minitest.rb#14
  sig { override.params(bt: T.nilable(T::Array[::String])).returns(T::Array[::String]) }
  def filter(bt); end
end

# source://spoom/lib/spoom/backtrace_filter/minitest.rb#11
...
class Spoom::Cli::Main < ::Thor
  ...
  # source://thor/1.3.0lib/thor.rb#334
  def bump(*args); end
...
class Spoom::Coverage::D3::ColorPalette < ::T::Struct
  ...
  class << self
    # source://sorbet-runtime/0.5.11294lib/types/struct.rb#13
    def inherited(s); end
  end
end
