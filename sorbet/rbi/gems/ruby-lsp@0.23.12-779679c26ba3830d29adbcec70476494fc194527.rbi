...
class RubyIndexer::Configuration
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/configuration.rb#24
  sig { void }
  def initialize; end

  # : (Hash[String, untyped] config) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/configuration.rb#184
  ...
  # : -> Array[URI::Generic]
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/configuration.rb#68
  ...
  # : -> Array[String]
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/configuration.rb#212
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/configuration.rb#266
  ...
  # : -> Array[String]
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/configuration.rb#273
  sig { returns(T::Array[::String]) }
  ...
  # @raise [ArgumentError]
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/configuration.rb#197
  sig { params(config: T::Hash[::String, T.untyped]).void }
...
class RubyIndexer::DeclarationListener
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#505
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#473
  sig do
    params(
      name: ::String,
  ...
  # : -> Entry::Namespace?
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#537
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#432
  sig { params(node: ::Prism::AliasMethodNode).void }
  def on_alias_method_node_enter(node); end

  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#255
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#81
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#243
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#221
  sig { params(node: ::Prism::ConstantPathAndWriteNode).void }
  def on_constant_path_and_write_node_enter(node); end

  # : (Prism::ConstantPathOperatorWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#211
  sig { params(node: ::Prism::ConstantPathOperatorWriteNode).void }
  def on_constant_path_operator_write_node_enter(node); end

  # : (Prism::ConstantPathOrWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#201
  sig { params(node: ::Prism::ConstantPathOrWriteNode).void }
  def on_constant_path_or_write_node_enter(node); end

  # : (Prism::ConstantPathWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#191
  sig { params(node: ::Prism::ConstantPathWriteNode).void }
  def on_constant_path_write_node_enter(node); end

  # : (Prism::ConstantWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#231
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#118
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#171
  ...
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#530
  sig { void }
  def pop_namespace_stack; end

  # : { (Index index, Entry::Namespace base) -> void } -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#520
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#668
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#1025
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#719
  sig { params(node: ::Prism::Node).returns(T.nilable(::String)) }
  def collect_comments(node); end

  # : (Integer line) -> bool
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#747
  sig { params(line: ::Integer).returns(T::Boolean) }
  def comment_exists_at?(line); end

  # : -> VisibilityScope
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#933
  ...
  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#629
  sig { params(node: ::Prism::CallNode).void }
  def handle_alias_method(node); end

  # : (Prism::CallNode node, reader: bool, writer: bool) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#761
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#557
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#582
  sig do
    params(
  ...
  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#840
  sig { params(node: ::Prism::CallNode).void }
  def handle_module_function(node); end

  # : (Prism::CallNode node, Symbol operation) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#806
  sig { params(node: ::Prism::CallNode, operation: ::Symbol).void }
  def handle_module_operation(node, operation); end

  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#891
  sig { params(node: ::Prism::CallNode).void }
  def handle_private_class_method(node); end

  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#604
  sig { params(node: ::Prism::CallNode).void }
  ...
  # : -> String?
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#1035
  sig { returns(T.nilable(::String)) }
  def last_name_in_stack; end

  # : (Prism::ParametersNode? parameters_node) -> Array[Entry::Parameter]
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#938
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/declaration_listener.rb#1000
...
class RubyIndexer::Enhancement
  ...
  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/enhancement.rb#44
  sig { overridable.params(node: ::Prism::CallNode).void }
  def on_call_node_enter(node); end

  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/enhancement.rb#48
  sig { overridable.params(node: ::Prism::CallNode).void }
  def on_call_node_leave(node); end
...
class RubyIndexer::Entry
  ...
  # : -> String
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#53
  sig { returns(::String) }
  def file_name; end
  ...
  # : RubyIndexer::Location
  #
  # source://sorbet-runtime/0.5.11915/lib/types/private/methods/_methods.rb#257
  def name_location(*args, **_arg1, &blk); end

  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#48
  sig { returns(T::Boolean) }
  def private?; end

  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#43
  sig { returns(T::Boolean) }
  def protected?; end
...
class RubyIndexer::Entry::BlockParameter < ::RubyIndexer::Entry::Parameter
  ...
  class << self
    # : -> BlockParameter
    #
    # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#280
...
class RubyIndexer::Entry::ConstantAlias < ::RubyIndexer::Entry
  ...
  # : String
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#402
  sig { returns(::String) }
  def target; end
end
...
class RubyIndexer::Entry::Member < ::RubyIndexer::Entry
  ...
  # @abstract
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#318
...
class RubyIndexer::Entry::Method < ::RubyIndexer::Entry::Member
  ...
  # : Location
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#363
  sig { returns(::RubyIndexer::Location) }
...
class RubyIndexer::Entry::MethodAlias < ::RubyIndexer::Entry
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#474
  sig do
    params(
  ...
  # : -> String
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#491
  sig { returns(::String) }
  def decorated_parameters; end
  ...
  # : -> Array[Signature]
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#501
...
class RubyIndexer::Entry::ModuleOperation
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#117
...
class RubyIndexer::Entry::Namespace < ::RubyIndexer::Entry
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#139
  sig do
    params(
      nesting: T::Array[::String],
      uri: ::URI::Generic,
...
class RubyIndexer::Entry::Signature
  ...
  # : -> String
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#520
  sig { returns(::String) }
  def format; end

  # : (Array[Prism::Node]? args, Array[Symbol] names) -> bool
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#604
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/entry.rb#540
...
class RubyIndexer::Index
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#54
  sig { void }
  def initialize; end

  # : (String fully_qualified_name) -> Array[Entry]?
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#136
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#631
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#148
  sig do
    params(
      name: ::String
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#429
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#205
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#647
  sig do
    params(
      uri: ::URI::Generic,
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#363
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#411
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#389
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#500
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#229
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#327
  sig do
    params(
      name: ::String,
      nesting: T::Array[::String],
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#589
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#578
  sig do
    params(
      variable_name: ::String,
      owner_name: ::String
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#462
  sig do
    params(
      method_name: ::String,
      receiver_name: ::String,
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#141
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#986
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#1007
  sig do
    params(
      full_name: ::String,
      seen_names: T::Array[::String]
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#947
  sig do
    params(
      name: T.nilable(::String),
      nesting: T::Array[::String]
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#776
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#817
  sig do
    params(
      ancestors: T::Array[::String],
  ...
  # : (String name, Array[String] nesting, Array[String] seen_names) -> Array[(Entry::Namespace | Entry::ConstantAlias | Entry::UnresolvedConstantAlias)]?
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#908
  sig do
    params(
      name: ::String,
      nesting: T::Array[::String],
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#885
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#1023
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/index.rb#747
...
class RubyIndexer::PrefixTree::Node
  ...
  # : -> Array[Value]
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/prefix_tree.rb#139
...
class RubyIndexer::RBSIndexer
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/rbs_indexer.rb#295
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/rbs_indexer.rb#278
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/rbs_indexer.rb#163
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/rbs_indexer.rb#222
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/rbs_indexer.rb#142
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/rbs_indexer.rb#215
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/rbs_indexer.rb#199
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/rbs_indexer.rb#134
...
class RubyIndexer::ReferenceFinder
  ...
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/reference_finder.rb#292
  sig { params(name: ::String, location: ::Prism::Location).void }
  def collect_constant_references(name, location); end

  # : (String name, Prism::Location location, bool declaration) -> void
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/reference_finder.rb#321
...
class RubyIndexer::VisibilityScope
  ...
  sig { params(visibility: ::RubyIndexer::Entry::Visibility, module_func: T::Boolean).void }
...
class RubyLsp::BaseServer
  ...
  # : -> untyped
  #
  # source://ruby-lsp//lib/ruby_lsp/base_server.rb#126
  sig { returns(T.untyped) }
  ...
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/base_server.rb#112
  sig { void }
  ...
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/base_server.rb#45
  sig { void }
  def start; end
end
...
class RubyLsp::ClientCapabilities
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/client_capabilities.rb#40
  ...
  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/client_capabilities.rb#67
  sig { returns(T::Boolean) }
...
class RubyLsp::ERBDocument < ::RubyLsp::Document
  ...
  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/erb_document.rb#30
...
class RubyLsp::ERBDocument::ERBScanner
  ...
  # : (String char) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/erb_document.rb#153
...
class RubyLsp::GlobalState
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#85
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#91
  ...
  # : (Symbol flag) -> bool?
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#185
  ...
  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#207
  sig { returns(T::Boolean) }
  def supports_watching_files; end
  ...
  # : -> String
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#190
  sig { returns(::String) }
  ...
  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#270
  sig { returns(T::Boolean) }
  def bin_rails_present; end

  # : (Array[String] direct_dependencies, Array[String] all_dependencies) -> String
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#214
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#230
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#261
  sig { params(dependencies: T::Array[::String]).returns(T::Boolean) }
  def detect_typechecker(dependencies); end

  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#275
  sig { returns(T::Boolean) }
  def dot_rubocop_yml_present; end

  # : -> Array[String]
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#297
  sig { returns(T::Array[::String]) }
  def gather_direct_and_indirect_dependencies; end

  # : -> Array[String]
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#280
  sig { returns(T::Array[::String]) }
  def gather_direct_dependencies; end

  # : -> Array[String]
  #
  # source://ruby-lsp//lib/ruby_lsp/global_state.rb#290
  sig { returns(T::Array[::String]) }
...
class RubyLsp::Listeners::CodeLens
  ...
  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/code_lens.rb#127
  sig { params(node: ::Prism::CallNode).void }
  def on_call_node_enter(node); end

  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/code_lens.rb#155
  sig { params(node: ::Prism::CallNode).void }
  def on_call_node_leave(node); end

  # : (Prism::ClassNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/code_lens.rb#53
  sig { params(node: ::Prism::ClassNode).void }
  def on_class_node_enter(node); end
  ...
  # : (Prism::DefNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/code_lens.rb#85
  sig { params(node: ::Prism::DefNode).void }
  def on_def_node_enter(node); end

  # : (Prism::DefNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/code_lens.rb#108
  sig { params(node: ::Prism::DefNode).void }
  def on_def_node_leave(node); end

  # : (Prism::ModuleNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/code_lens.rb#113
  sig { params(node: ::Prism::ModuleNode).void }
  def on_module_node_enter(node); end

  # : (Prism::ModuleNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/code_lens.rb#122
  sig { params(node: ::Prism::ModuleNode).void }
  def on_module_node_leave(node); end
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/code_lens.rb#260
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/code_lens.rb#298
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/code_lens.rb#213
  sig do
    params(
...
class RubyLsp::Listeners::Completion
  ...
  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#142
  sig { params(node: ::Prism::CallNode).void }
  def on_call_node_enter(node); end

  # : (Prism::ClassVariableAndWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#246
  sig { params(node: ::Prism::ClassVariableAndWriteNode).void }
  def on_class_variable_and_write_node_enter(node); end

  # : (Prism::ClassVariableOperatorWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#251
  sig { params(node: ::Prism::ClassVariableOperatorWriteNode).void }
  def on_class_variable_operator_write_node_enter(node); end

  # : (Prism::ClassVariableOrWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#256
  sig { params(node: ::Prism::ClassVariableOrWriteNode).void }
  def on_class_variable_or_write_node_enter(node); end
  ...
  # : (Prism::ClassVariableTargetNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#261
  sig { params(node: ::Prism::ClassVariableTargetNode).void }
  def on_class_variable_target_node_enter(node); end

  # : (Prism::ClassVariableWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#271
  sig { params(node: ::Prism::ClassVariableWriteNode).void }
  def on_class_variable_write_node_enter(node); end
  ...
  # : (Prism::ConstantPathNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#124
  sig { params(node: ::Prism::ConstantPathNode).void }
  def on_constant_path_node_enter(node); end
  ...
  # : (Prism::GlobalVariableAndWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#186
  sig { params(node: ::Prism::GlobalVariableAndWriteNode).void }
  def on_global_variable_and_write_node_enter(node); end

  # : (Prism::GlobalVariableOperatorWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#191
  sig { params(node: ::Prism::GlobalVariableOperatorWriteNode).void }
  def on_global_variable_operator_write_node_enter(node); end

  # : (Prism::GlobalVariableOrWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#196
  sig { params(node: ::Prism::GlobalVariableOrWriteNode).void }
  def on_global_variable_or_write_node_enter(node); end

  # : (Prism::GlobalVariableReadNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#201
  sig { params(node: ::Prism::GlobalVariableReadNode).void }
  def on_global_variable_read_node_enter(node); end

  # : (Prism::GlobalVariableTargetNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#206
  sig { params(node: ::Prism::GlobalVariableTargetNode).void }
  def on_global_variable_target_node_enter(node); end

  # : (Prism::GlobalVariableWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#211
  sig { params(node: ::Prism::GlobalVariableWriteNode).void }
  def on_global_variable_write_node_enter(node); end

  # : (Prism::InstanceVariableAndWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#226
  sig { params(node: ::Prism::InstanceVariableAndWriteNode).void }
  def on_instance_variable_and_write_node_enter(node); end
  ...
  # : (Prism::InstanceVariableOrWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#236
  sig { params(node: ::Prism::InstanceVariableOrWriteNode).void }
  def on_instance_variable_or_write_node_enter(node); end

  # : (Prism::InstanceVariableReadNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#216
  sig { params(node: ::Prism::InstanceVariableReadNode).void }
  def on_instance_variable_read_node_enter(node); end

  # : (Prism::InstanceVariableTargetNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#241
  sig { params(node: ::Prism::InstanceVariableTargetNode).void }
  def on_instance_variable_target_node_enter(node); end

  # : (Prism::InstanceVariableWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#221
  sig { params(node: ::Prism::InstanceVariableWriteNode).void }
  def on_instance_variable_write_node_enter(node); end
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#553
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#586
  sig do
    params(
      real_name: ::String,
  ...
  # : (Prism::CallNode node, String name) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#469
  sig { params(node: ::Prism::CallNode, name: ::String).void }
  def complete_methods(node, name); end

  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#421
  sig { params(node: ::Prism::CallNode).void }
  def complete_require(node); end

  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#437
  sig { params(node: ::Prism::CallNode).void }
  def complete_require_relative(node); end

  # : (String name, Interface::Range range) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#278
  sig { params(name: ::String, range: ::LanguageServer::Protocol::Interface::Range).void }
  def constant_path_completion(name, range); end

  # : (String name, Prism::Location location) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#356
  sig { params(name: ::String, location: ::Prism::Location).void }
  def handle_class_variable_completion(name, location); end

  # : (String name, Prism::Location location) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#333
  sig { params(name: ::String, location: ::Prism::Location).void }
  def handle_global_variable_completion(name, location); end

  # : (String name, Prism::Location location) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#387
  sig { params(name: ::String, location: ::Prism::Location).void }
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/completion.rb#675
...
class RubyLsp::Listeners::DocumentHighlight
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#89
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#245
  sig { params(node: ::Prism::BlockParameterNode).void }
  def on_block_parameter_node_enter(node); end

  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#183
  sig { params(node: ::Prism::CallNode).void }
  def on_call_node_enter(node); end

  # : (Prism::CaseNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#531
  ...
  # : (Prism::ClassVariableAndWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#433
  sig { params(node: ::Prism::ClassVariableAndWriteNode).void }
  def on_class_variable_and_write_node_enter(node); end

  # : (Prism::ClassVariableOperatorWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#426
  sig { params(node: ::Prism::ClassVariableOperatorWriteNode).void }
  def on_class_variable_operator_write_node_enter(node); end

  # : (Prism::ClassVariableOrWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#419
  sig { params(node: ::Prism::ClassVariableOrWriteNode).void }
  def on_class_variable_or_write_node_enter(node); end

  # : (Prism::ClassVariableReadNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#305
  sig { params(node: ::Prism::ClassVariableReadNode).void }
  def on_class_variable_read_node_enter(node); end

  # : (Prism::ClassVariableTargetNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#231
  sig { params(node: ::Prism::ClassVariableTargetNode).void }
  def on_class_variable_target_node_enter(node); end

  # : (Prism::ClassVariableWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#412
  sig { params(node: ::Prism::ClassVariableWriteNode).void }
  def on_class_variable_write_node_enter(node); end

  # : (Prism::ConstantAndWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#489
  sig { params(node: ::Prism::ConstantAndWriteNode).void }
  def on_constant_and_write_node_enter(node); end

  # : (Prism::ConstantOperatorWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#454
  sig { params(node: ::Prism::ConstantOperatorWriteNode).void }
  def on_constant_operator_write_node_enter(node); end

  # : (Prism::ConstantOrWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#447
  sig { params(node: ::Prism::ConstantOrWriteNode).void }
  def on_constant_or_write_node_enter(node); end

  # : (Prism::ConstantPathAndWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#333
  sig { params(node: ::Prism::ConstantPathAndWriteNode).void }
  def on_constant_path_and_write_node_enter(node); end

  # : (Prism::ConstantPathNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#284
  sig { params(node: ::Prism::ConstantPathNode).void }
  def on_constant_path_node_enter(node); end

  # : (Prism::ConstantPathOperatorWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#340
  sig { params(node: ::Prism::ConstantPathOperatorWriteNode).void }
  def on_constant_path_operator_write_node_enter(node); end

  # : (Prism::ConstantPathOrWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#326
  sig { params(node: ::Prism::ConstantPathOrWriteNode).void }
  def on_constant_path_or_write_node_enter(node); end

  # : (Prism::ConstantPathTargetNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#217
  sig { params(node: ::Prism::ConstantPathTargetNode).void }
  def on_constant_path_target_node_enter(node); end

  # : (Prism::ConstantPathWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#319
  sig { params(node: ::Prism::ConstantPathWriteNode).void }
  def on_constant_path_write_node_enter(node); end

  # : (Prism::ConstantReadNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#291
  sig { params(node: ::Prism::ConstantReadNode).void }
  def on_constant_read_node_enter(node); end

  # : (Prism::ConstantTargetNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#224
  sig { params(node: ::Prism::ConstantTargetNode).void }
  def on_constant_target_node_enter(node); end

  # : (Prism::ConstantWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#440
  sig { params(node: ::Prism::ConstantWriteNode).void }
  def on_constant_write_node_enter(node); end
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#552
  sig { params(node: ::Prism::ForNode).void }
  def on_for_node_enter(node); end

  # : (Prism::GlobalVariableAndWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#510
  sig { params(node: ::Prism::GlobalVariableAndWriteNode).void }
  def on_global_variable_and_write_node_enter(node); end
  ...
  # : (Prism::GlobalVariableOrWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#503
  sig { params(node: ::Prism::GlobalVariableOrWriteNode).void }
  def on_global_variable_or_write_node_enter(node); end

  # : (Prism::GlobalVariableReadNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#312
  sig { params(node: ::Prism::GlobalVariableReadNode).void }
  def on_global_variable_read_node_enter(node); end
  ...
  # : (Prism::GlobalVariableWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#496
  sig { params(node: ::Prism::GlobalVariableWriteNode).void }
  def on_global_variable_write_node_enter(node); end

  # : (Prism::IfNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#559
  sig { params(node: ::Prism::IfNode).void }
  def on_if_node_enter(node); end

  # : (Prism::InstanceVariableAndWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#475
  sig { params(node: ::Prism::InstanceVariableAndWriteNode).void }
  def on_instance_variable_and_write_node_enter(node); end

  # : (Prism::InstanceVariableOperatorWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#482
  sig { params(node: ::Prism::InstanceVariableOperatorWriteNode).void }
  def on_instance_variable_operator_write_node_enter(node); end

  # : (Prism::InstanceVariableOrWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#468
  sig { params(node: ::Prism::InstanceVariableOrWriteNode).void }
  def on_instance_variable_or_write_node_enter(node); end

  # : (Prism::InstanceVariableReadNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#298
  sig { params(node: ::Prism::InstanceVariableReadNode).void }
  def on_instance_variable_read_node_enter(node); end

  # : (Prism::InstanceVariableTargetNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#210
  sig { params(node: ::Prism::InstanceVariableTargetNode).void }
  def on_instance_variable_target_node_enter(node); end

  # : (Prism::InstanceVariableWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#461
  sig { params(node: ::Prism::InstanceVariableWriteNode).void }
  def on_instance_variable_write_node_enter(node); end
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#238
  sig { params(node: ::Prism::LocalVariableTargetNode).void }
  def on_local_variable_target_node_enter(node); end

  # : (Prism::LocalVariableWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#347
  ...
  # : (Prism::SingletonClassNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#524
  sig { params(node: ::Prism::SingletonClassNode).void }
  def on_singleton_class_node_enter(node); end

  # : (Prism::UnlessNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#566
  sig { params(node: ::Prism::UnlessNode).void }
  def on_unless_node_enter(node); end

  # : (Prism::UntilNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#545
  sig { params(node: ::Prism::UntilNode).void }
  def on_until_node_enter(node); end

  # : (Prism::WhileNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#538
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#580
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#613
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#623
  ...
  # : (Prism::Node? node) -> String?
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_highlight.rb#585
...
class RubyLsp::Listeners::DocumentLink
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_link.rb#58
  sig do
    params(
  ...
  # : (Prism::ClassNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_link.rb#88
  sig { params(node: ::Prism::ClassNode).void }
  def on_class_node_enter(node); end
  ...
  # : (Prism::DefNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_link.rb#83
  sig { params(node: ::Prism::DefNode).void }
  def on_def_node_enter(node); end
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_link.rb#110
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/document_link.rb#151
  ...
  class << self
    ...
    #
    # source://ruby-lsp//lib/ruby_lsp/listeners/document_link.rb#20
...
class RubyLsp::Listeners::FoldingRanges
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/folding_ranges.rb#248
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/folding_ranges.rb#231
  sig { params(node: T.any(::Prism::IfNode, ::Prism::InNode, ::Prism::RescueNode, ::Prism::WhenNode)).void }
  def add_statements_range(node); end

  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/folding_ranges.rb#204
  sig { void }
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/folding_ranges.rb#217
...
class RubyLsp::Listeners::Hover
  ...
  # : (Prism::GlobalVariableAndWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/hover.rb#146
  sig { params(node: ::Prism::GlobalVariableAndWriteNode).void }
  def on_global_variable_and_write_node_enter(node); end

  # : (Prism::GlobalVariableOperatorWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/hover.rb#151
  sig { params(node: ::Prism::GlobalVariableOperatorWriteNode).void }
  def on_global_variable_operator_write_node_enter(node); end
  ...
  # : (Prism::InterpolatedStringNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/hover.rb#99
  sig { params(node: ::Prism::InterpolatedStringNode).void }
  def on_interpolated_string_node_enter(node); end

  # : (Prism::StringNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/hover.rb#94
  sig { params(node: ::Prism::StringNode).void }
  def on_string_node_enter(node); end
...
class RubyLsp::Listeners::SemanticHighlighting
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#21
  sig do
    params(
      dispatcher: ::Prism::Dispatcher,
      response_builder: RubyLsp::ResponseBuilders::SemanticHighlighting
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#118
  ...
  # : (Prism::BlockNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#113
  sig { params(node: ::Prism::BlockNode).void }
  ...
  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#60
  sig { params(node: ::Prism::CallNode).void }
  def on_call_node_enter(node); end

  # : (Prism::ClassNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#216
  sig { params(node: ::Prism::ClassNode).void }
  def on_class_node_enter(node); end

  # : (Prism::DefNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#98
  sig { params(node: ::Prism::DefNode).void }
  def on_def_node_enter(node); end
  ...
  # : (Prism::ImplicitNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#281
  sig { params(node: ::Prism::ImplicitNode).void }
  def on_implicit_node_leave(node); end

  # : (Prism::KeywordRestParameterNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#139
  sig { params(node: ::Prism::KeywordRestParameterNode).void }
  def on_keyword_rest_parameter_node_enter(node); end

  # : (Prism::LocalVariableAndWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#186
  sig { params(node: ::Prism::LocalVariableAndWriteNode).void }
  def on_local_variable_and_write_node_enter(node); end
  ...
  # : (Prism::LocalVariableWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#166
  sig { params(node: ::Prism::LocalVariableWriteNode).void }
  def on_local_variable_write_node_enter(node); end

  # : (Prism::MatchWriteNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#83
  ...
  # : (Prism::OptionalKeywordParameterNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#134
  sig { params(node: ::Prism::OptionalKeywordParameterNode).void }
  def on_optional_keyword_parameter_node_enter(node); end
  ...
  # : (Prism::RestParameterNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#155
  sig { params(node: ::Prism::RestParameterNode).void }
  def on_rest_parameter_node_enter(node); end
  ...
  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/semantic_highlighting.rb#295
  sig { params(node: ::Prism::CallNode).void }
...
class RubyLsp::Listeners::SignatureHelp
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/signature_help.rb#86
  sig do
    params(
      signatures: T::Array[::RubyIndexer::Entry::Signature],
      method_name: ::String,
...
class RubyLsp::Listeners::SpecStyle
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#13
  sig do
    params(
      response_builder: RubyLsp::ResponseBuilders::TestCollection,
      global_state: ::RubyLsp::GlobalState,
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#79
  sig { params(node: ::Prism::CallNode).void }
  def on_call_node_enter(node); end

  # : (node: Prism::CallNode) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#89
  sig { params(node: ::Prism::CallNode).void }
  def on_call_node_leave(node); end

  # : (node: Prism::ClassNode) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#34
  sig { params(node: ::Prism::ClassNode).void }
  def on_class_node_enter(node); end
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#56
  sig { params(node: ::Prism::ModuleNode).void }
  def on_module_node_enter(node); end

  # : (node: Prism::ModuleNode) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#66
  sig { params(node: ::Prism::ModuleNode).void }
  def on_module_node_leave(node); end
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#135
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#171
  sig { params(node: ::Prism::CallNode).returns(T.nilable(::String)) }
  def extract_description(node); end

  # : -> Requests::Support::TestItem?
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#150
  sig { returns(T.nilable(::RubyLsp::Requests::Support::TestItem)) }
  def find_parent_test_group; end

  # : (node: Prism::CallNode) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#98
  sig { params(node: ::Prism::CallNode).void }
  def handle_describe(node); end

  # : (node: Prism::CallNode) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#123
  sig { params(node: ::Prism::CallNode).void }
  def handle_example(node); end

  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#186
  sig { returns(T::Boolean) }
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/spec_style.rb#193
  sig do
    params(
      node: T.any(::Prism::CallNode, ::Prism::ConstantPathNode, ::Prism::ConstantPathTargetNode, ::Prism::ConstantReadNode, ::Prism::MissingNode)
    ).returns(::String)
...
class RubyLsp::Listeners::TestStyle
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/test_style.rb#134
  sig do
    params(
      response_builder: RubyLsp::ResponseBuilders::TestCollection,
      global_state: ::RubyLsp::GlobalState,
  ...
  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/test_style.rb#232
  sig { params(node: ::Prism::CallNode).void }
  def on_call_node_enter(node); end

  # : (Prism::CallNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/test_style.rb#240
  sig { params(node: ::Prism::CallNode).void }
  def on_call_node_leave(node); end
  ...
  # : (Prism::ModuleNode node) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/test_style.rb#186
  sig { params(node: ::Prism::ModuleNode).void }
  def on_module_node_enter(node); end
  ...
  # : ((Prism::ConstantPathNode | Prism::ConstantReadNode | Prism::ConstantPathTargetNode | Prism::CallNode | Prism::MissingNode) node) -> String
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/test_style.rb#264
  sig do
    params(
      node: T.any(::Prism::CallNode, ::Prism::ConstantPathNode, ::Prism::ConstantPathTargetNode, ::Prism::ConstantReadNode, ::Prism::MissingNode)
    ).returns(::String)
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/listeners/test_style.rb#251
  ...
  class << self
    ...
    #
    # source://ruby-lsp//lib/ruby_lsp/listeners/test_style.rb#77
    sig do
      params(
        file_path: ::String,
    ...
    #
    # source://ruby-lsp//lib/ruby_lsp/listeners/test_style.rb#100
    sig do
      params(
        file_path: ::String,
        groups_and_examples: T::Hash[::String, T::Hash[::Symbol, T.untyped]]
...
class RubyLsp::Notification < ::RubyLsp::Message
  ...
  class << self
    ...
    #
    # source://ruby-lsp//lib/ruby_lsp/utils.rb#92
    sig do
      params(
        id: ::String,
        title: ::String,
    ...
    #
    # source://ruby-lsp//lib/ruby_lsp/utils.rb#123
    ...
    #
    # source://ruby-lsp//lib/ruby_lsp/utils.rb#108
    sig do
      params(
        id: ::String,
        percentage: T.nilable(::Integer),
    ...
    #
    # source://ruby-lsp//lib/ruby_lsp/utils.rb#134
    sig do
      params(
        uri: ::String,
...
class RubyLsp::Requests::CodeActionResolve < ::RubyLsp::Requests::Request
  ...
  # : -> (Interface::CodeAction | Error)
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/code_action_resolve.rb#334
  sig do
    returns(T.any(::LanguageServer::Protocol::Interface::CodeAction, ::RubyLsp::Requests::CodeActionResolve::Error))
  end
  ...
  # : -> (Interface::CodeAction | Error)
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/code_action_resolve.rb#193
  sig do
    returns(T.any(::LanguageServer::Protocol::Interface::CodeAction, ::RubyLsp::Requests::CodeActionResolve::Error))
  end
  ...
  # : -> (Interface::CodeAction | Error)
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/code_action_resolve.rb#95
  sig do
    returns(T.any(::LanguageServer::Protocol::Interface::CodeAction, ::RubyLsp::Requests::CodeActionResolve::Error))
  end
  ...
  # : -> (Interface::CodeAction | Error)
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/code_action_resolve.rb#57
  sig do
    returns(T.any(::LanguageServer::Protocol::Interface::CodeAction, ::RubyLsp::Requests::CodeActionResolve::Error))
  end
...
class RubyLsp::Requests::CodeActions < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/code_actions.rb#40
  sig do
    params(
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/code_actions.rb#83
  ...
  class << self
    ...
    #
    # source://ruby-lsp//lib/ruby_lsp/requests/code_actions.rb#31
...
class RubyLsp::Requests::Completion < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/completion.rb#95
...
class RubyLsp::Requests::Definition < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/definition.rb#15
  sig do
    params(
      document: T.any(RubyLsp::ERBDocument, RubyLsp::RubyDocument),
      global_state: ::RubyLsp::GlobalState,
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/definition.rb#99
  sig do
    override
...
class RubyLsp::Requests::DiscoverTests < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/discover_tests.rb#15
  sig do
    params(
      global_state: ::RubyLsp::GlobalState,
      document: RubyLsp::RubyDocument,
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/discover_tests.rb#26
...
class RubyLsp::Requests::DocumentHighlight < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/document_highlight.rb#43
...
class RubyLsp::Requests::DocumentLink < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/document_link.rb#31
...
class RubyLsp::Requests::GoToRelevantFile < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/go_to_relevant_file.rb#23
  sig { params(path: ::String, workspace_path: ::String).void }
  def initialize(path, workspace_path); end

  # : -> Array[String]
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/go_to_relevant_file.rb#32
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/go_to_relevant_file.rb#67
  sig { params(candidates: T::Array[::String]).returns(T::Array[::String]) }
  def find_most_similar_with_jaccard(candidates); end

  # : -> Array[String]
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/go_to_relevant_file.rb#39
  sig { returns(T::Array[::String]) }
  def find_relevant_paths; end

  # : (String path) -> Set[String]
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/go_to_relevant_file.rb#82
  sig { params(path: ::String).returns(T::Set[::String]) }
  def get_dir_parts(path); end

  # : -> String
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/go_to_relevant_file.rb#47
  sig { returns(::String) }
...
class RubyLsp::Requests::Hover < ::RubyLsp::Requests::Request
  ...
  class << self
    ...
    #
    # source://ruby-lsp//lib/ruby_lsp/requests/hover.rb#15
...
class RubyLsp::Requests::InlayHints < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/inlay_hints.rb#32
...
class RubyLsp::Requests::OnTypeFormatting < ::RubyLsp::Requests::Request
  ...
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/on_type_formatting.rb#199
  sig { void }
  def auto_indent_after_end_keyword; end

  # : (String line) -> Integer
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/on_type_formatting.rb#186
  sig { params(line: ::String).returns(::Integer) }
  def find_indentation(line); end

  # : (String spaces) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/on_type_formatting.rb#147
  sig { params(spaces: ::String).void }
  def handle_comment_line(spaces); end

  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/on_type_formatting.rb#109
  sig { void }
  ...
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/on_type_formatting.rb#78
  sig { void }
  def handle_pipe; end

  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/on_type_formatting.rb#117
  sig { void }
  def handle_statement_end; end

  # : (Integer line, Integer character) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/on_type_formatting.rb#165
...
class RubyLsp::Requests::References < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/references.rb#125
  sig do
    params(
      target: ::RubyIndexer::ReferenceFinder::Target,
      parse_result: ::Prism::ParseResult,
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/references.rb#100
  sig do
    params(
...
class RubyLsp::Requests::Rename < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/rename.rb#95
  sig do
    params(
      fully_qualified_name: ::String,
...
class RubyLsp::Requests::SemanticHighlighting < ::RubyLsp::Requests::Request
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/semantic_highlighting.rb#98
  sig do
    override
...
module RubyLsp::Requests::Support::Common
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/common.rb#162
...
class RubyLsp::Requests::Support::RuboCopDiagnostic
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_diagnostic.rb#33
  ...
  # : -> Array[Interface::CodeAction]
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_diagnostic.rb#40
  sig { returns(T::Array[::LanguageServer::Protocol::Interface::CodeAction]) }
  def to_lsp_code_actions; end

  # : (::RuboCop::Config config) -> Interface::Diagnostic
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_diagnostic.rb#50
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_diagnostic.rb#105
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_diagnostic.rb#92
  ...
  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_diagnostic.rb#199
  sig { returns(T::Boolean) }
  def correctable?; end

  # : -> Interface::CodeAction
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_diagnostic.rb#138
  sig { returns(::LanguageServer::Protocol::Interface::CodeAction) }
  def disable_line_action; end

  # : (String line) -> Integer
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_diagnostic.rb#180
  sig { params(line: ::String).returns(::Integer) }
  def length_of_line(line); end

  # : -> Array[Interface::TextEdit]
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_diagnostic.rb#157
  ...
  # : -> Array[Interface::TextEdit]
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_diagnostic.rb#125
  sig { returns(T::Array[::LanguageServer::Protocol::Interface::TextEdit]) }
...
class RubyLsp::Requests::Support::RuboCopRunner < ::RuboCop::Runner
  ...
  # : -> String
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_runner.rb#121
  sig { returns(::String) }
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_runner.rb#99
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/rubocop_runner.rb#145
...
class RubyLsp::Requests::Support::Sorbet
  class << self
    # : (Prism::CallNode node) -> bool
    #
    # source://ruby-lsp//lib/ruby_lsp/requests/support/sorbet.rb#42
    sig { params(node: ::Prism::CallNode).returns(T::Boolean) }
...
class RubyLsp::Requests::Support::TestItem
  ...
  def initialize(id, label, uri, range, tags: T.unsafe(nil)); end

  # : (String id) -> TestItem?
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/test_item.rb#32
  sig { params(id: ::String).returns(T.nilable(::RubyLsp::Requests::Support::TestItem)) }
  def [](id); end

  # : (TestItem item) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/test_item.rb#27
  sig { params(item: ::RubyLsp::Requests::Support::TestItem).void }
  def add(item); end

  # : -> Array[TestItem]
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/test_item.rb#37
  ...
  # : (Symbol) -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/test_item.rb#42
  sig { params(tag: ::Symbol).returns(T::Boolean) }
  def tag?(tag); end

  # : -> Hash[Symbol, untyped]
  #
  # source://ruby-lsp//lib/ruby_lsp/requests/support/test_item.rb#47
  sig { returns(T::Hash[::Symbol, T.untyped]) }
  def to_hash; end
end
...
class RubyLsp::ResponseBuilders::DocumentSymbol < ::RubyLsp::ResponseBuilders::ResponseBuilder
  ...
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/document_symbol.rb#20
  sig { void }
  def initialize; end
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/document_symbol.rb#43
  sig do
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/document_symbol.rb#36
  sig { returns(T.nilable(::LanguageServer::Protocol::Interface::DocumentSymbol)) }
  def pop; end

  # : (Interface::DocumentSymbol symbol) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/document_symbol.rb#29
  sig { params(symbol: ::LanguageServer::Protocol::Interface::DocumentSymbol).void }
  def push(symbol); end

  # : -> Array[Interface::DocumentSymbol]
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/document_symbol.rb#49
  sig { override.returns(T::Array[::LanguageServer::Protocol::Interface::DocumentSymbol]) }
  def response; end
end
...
class RubyLsp::ResponseBuilders::DocumentSymbol::SymbolHierarchyRoot
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/document_symbol.rb#14
  sig { void }
  def initialize; end
...
class RubyLsp::ResponseBuilders::Hover < ::RubyLsp::ResponseBuilders::ResponseBuilder
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/hover.rb#26
...
class RubyLsp::ResponseBuilders::SemanticHighlighting < ::RubyLsp::ResponseBuilders::ResponseBuilder
  ...
  # : -> SemanticToken?
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#89
  sig { returns(T.nilable(::RubyLsp::ResponseBuilders::SemanticHighlighting::SemanticToken)) }
  def last; end

  # : (Prism::Location location) -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#80
  sig { params(location: ::Prism::Location).returns(T::Boolean) }
...
class RubyLsp::ResponseBuilders::SemanticHighlighting::SemanticToken
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#116
  sig do
    params(
      start_line: ::Integer,
  ...
  # : Integer
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#107
  sig { returns(::Integer) }
  def length; end

  # : Array[Integer]
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#113
  sig { returns(T::Array[::Integer]) }
  def modifier; end

  # : (Array[Symbol] modifier_symbols) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#133
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#125
  ...
  # : Integer
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#110
  sig { returns(::Integer) }
  def type; end
end
...
class RubyLsp::ResponseBuilders::SemanticHighlighting::SemanticTokenEncoder
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#145
  sig { void }
  def initialize; end
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#176
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/semantic_highlighting.rb#151
  sig do
    params(
...
class RubyLsp::ResponseBuilders::SignatureHelp < ::RubyLsp::ResponseBuilders::ResponseBuilder
  ...
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/signature_help.rb#10
  sig { void }
  def initialize; end

  # : (ResponseType signature_help) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/signature_help.rb#16
  sig { params(signature_help: ResponseType).void }
  def replace(signature_help); end

  # : -> ResponseType
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/signature_help.rb#22
  sig { override.returns(ResponseType) }
  def response; end
end
...
class RubyLsp::ResponseBuilders::TestCollection < ::RubyLsp::ResponseBuilders::ResponseBuilder
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/test_collection.rb#23
  sig { params(id: ::String).returns(T.nilable(ResponseType)) }
  def [](id); end

  # : (ResponseType item) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/test_collection.rb#18
  sig { params(item: ResponseType).void }
  def add(item); end

  # : -> Array[ResponseType]
  #
  # source://ruby-lsp//lib/ruby_lsp/response_builders/test_collection.rb#29
  sig { override.returns(T::Array[ResponseType]) }
  def response; end
end
...
class RubyLsp::RubyDocument < ::RubyLsp::Document
  ...
  # : -> LanguageId
  #
  # source://ruby-lsp//lib/ruby_lsp/ruby_document.rb#171
  sig { override.returns(::RubyLsp::Document::LanguageId) }
  def language_id; end

  # : (Hash[Symbol, untyped] range, ?node_types: Array[singleton(Prism::Node)]) -> Prism::Node?
  #
  # source://ruby-lsp//lib/ruby_lsp/ruby_document.rb#196
  sig do
    params(
      range: T::Hash[::Symbol, T.untyped],
      node_types: T::Array[T.class_of(Prism::Node)]
  ...
  # : (Hash[Symbol, untyped] position, ?node_types: Array[singleton(Prism::Node)]) -> NodeContext
  #
  # source://ruby-lsp//lib/ruby_lsp/ruby_document.rb#224
  sig do
    params(
      position: T::Hash[::Symbol, T.untyped],
      node_types: T::Array[T.class_of(Prism::Node)]
  ...
  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/ruby_document.rb#154
  sig { override.returns(T::Boolean) }
  def parse!; end

  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/ruby_document.rb#236
  sig { returns(T::Boolean) }
  def should_index?; end

  # : -> SorbetLevel
  #
  # source://ruby-lsp//lib/ruby_lsp/ruby_document.rb#176
  ...
  # : -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/ruby_document.rb#247
  sig { returns(T::Boolean) }
  def last_edit_may_change_declarations?; end

  # : (Hash[Symbol, Integer] position) -> bool
  #
  # source://ruby-lsp//lib/ruby_lsp/ruby_document.rb#261
...
class RubyLsp::Server < ::RubyLsp::BaseServer
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#176
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#168
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1268
  sig { params(id: ::String, title: ::String, percentage: ::Integer).void }
  def begin_progress(id, title, percentage: T.unsafe(nil)); end

  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1298
  sig { void }
  def check_formatter_is_available; end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#857
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1372
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1419
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1439
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  ...
  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1236
  sig { void }
  def perform_initial_indexing; end

  # : (Hash[Symbol, untyped]? indexing_options) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1316
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1281
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#216
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def run_initialize(message); end

  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#354
  sig { void }
  def run_initialized; end

  # : -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1231
  sig { override.void }
  def shutdown; end
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#835
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#922
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def text_document_completion(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#947
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def text_document_completion_item_resolve(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#992
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def text_document_definition(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#882
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#629
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#689
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def text_document_on_type_formatting(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#757
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def text_document_prepare_rename(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1167
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def text_document_prepare_type_hierarchy(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#601
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def text_document_range_formatting(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#775
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#547
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def text_document_semantic_tokens_delta(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#526
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1129
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def text_document_show_syntax_tree(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#966
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def text_document_signature_help(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1195
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def type_hierarchy_subtypes(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1186
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def type_hierarchy_supertypes(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1357
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  ...
  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1017
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
  def workspace_did_change_watched_files(message); end

  # : (Hash[Symbol, untyped] message) -> void
  #
  # source://ruby-lsp//lib/ruby_lsp/server.rb#1116
  sig { params(message: T::Hash[::Symbol, T.untyped]).void }
...
class RubyLsp::Store
  ...
  #
  # source://ruby-lsp//lib/ruby_lsp/store.rb#102
  sig do
    type_parameters(:T)
      .params(
        uri: ::URI::Generic,
...
module RubyLsp::TestHelper
  ...
  # source://ruby-lsp//lib/ruby_lsp/test_helper.rb#64
  def pop_log_notification(message_queue, type); end

  # source://ruby-lsp//lib/ruby_lsp/test_helper.rb#72
  def pop_message(outgoing_queue, &block); end

  # : (RubyLsp::Server server) -> RubyLsp::Result
  #
  # source://ruby-lsp//lib/ruby_lsp/test_helper.rb#53
...
class URI::Generic
  # : String?
  #
  # source://ruby-lsp//lib/ruby_indexer/lib/ruby_indexer/uri.rb#39
