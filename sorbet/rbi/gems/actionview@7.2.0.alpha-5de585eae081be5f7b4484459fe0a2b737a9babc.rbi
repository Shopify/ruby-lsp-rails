...
module ActionView::Helpers::TagHelper
  ...
  #
  # source://actionview/lib/action_view/helpers/tag_helper.rb#385
  ...
  #    # => "123 foo bar"
  #
  # source://actionview/lib/action_view/helpers/tag_helper.rb#365
  ...
  #
  # source://actionview/lib/action_view/helpers/tag_helper.rb#345
  ...
  #   # => "&lt;&lt; Accept &amp; Checkout"
  #
  # source://actionview/lib/action_view/helpers/tag_helper.rb#397
  ...
  #   # => <div class="highlight" />
  #
  # source://actionview/lib/action_view/helpers/tag_helper.rb#308
  ...
  # source://actionview/lib/action_view/helpers/tag_helper.rb#407
  ...
  # source://actionview/lib/action_view/helpers/tag_helper.rb#427
  def tag_builder; end
...
# source://actionview/lib/action_view/render_parser.rb#34
ActionView::RenderParser::Parser = ActionView::RenderParser::RipperRenderParser

# source://actionview/lib/action_view/render_parser.rb#6
ActionView::RenderParser::RENDER_TYPE_KEYS = T.let(T.unsafe(nil), Array)

# source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#5
class ActionView::RenderParser::RipperRenderParser < ::ActionView::RenderParser::Base
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#184
  ...
  #   render(partial: "foo", ...)
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#210
  def normalize_args(string, options_hash); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#242
  def parse_hash(node); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#246
  def parse_hash_to_symbols(node); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#218
  def parse_render(node); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#260
  def parse_render_from_options(options_hash); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#320
  def parse_str(node); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#324
  def parse_sym(node); end

  # @return [Boolean]
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#328
  def render_template_with_layout?(render_type, options_hash); end

  # @return [Boolean]
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#334
  def render_template_with_spacer?(options_hash); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#196
  def resolve_path_directory(path); end
end

# source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#6
class ActionView::RenderParser::RipperRenderParser::Node < ::Array
  # @return [Node] a new instance of Node
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#9
  def initialize(type, arr, opts = T.unsafe(nil)); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#33
  def argument_nodes; end

  # @return [Boolean]
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#55
  def call?; end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#63
  def call_method_name; end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#14
  def children; end

  # @return [Boolean]
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#23
  def fcall?; end

  # @return [Boolean]
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#27
  def fcall_named?(name); end

  # @return [Boolean]
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#72
  def hash?; end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#86
  def hash_from_body(body); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#18
  def inspect; end

  # @return [Boolean]
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#43
  def string?; end

  # @return [Boolean]
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#94
  def symbol?; end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#76
  def to_hash; end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#67
  def to_string; end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#98
  def to_symbol; end

  # Returns the value of attribute type.
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#7
  def type; end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#59
  def variable_name; end

  # @return [Boolean]
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#47
  def variable_reference?; end

  # @return [Boolean]
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#51
  def vcall?; end
end

# source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#109
class ActionView::RenderParser::RipperRenderParser::NodeParser < ::Ripper
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#129
  def on_BEGIN(*args); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#138
  def on_CHAR(tok); end
  ...
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#121
  ...
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#114
...
# source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#145
class ActionView::RenderParser::RipperRenderParser::RenderCallExtractor < ::ActionView::RenderParser::RipperRenderParser::NodeParser
  # @return [RenderCallExtractor] a new instance of RenderCallExtractor
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#150
  def initialize(*args); end

  # Returns the value of attribute render_calls.
  #
  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#146
  def render_calls; end

  private

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#175
  def on_arg_paren(content); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#161
  def on_command(name, *args); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#157
  def on_fcall(name, *args); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#179
  def on_paren(content); end

  # source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#165
  def on_render_call(node); end
end

# source://actionview/lib/action_view/render_parser/ripper_render_parser.rb#148
ActionView::RenderParser::RipperRenderParser::RenderCallExtractor::METHODS_TO_PARSE = T.let(T.unsafe(nil), Array)
...
module ActionView::RoutingUrlFor
  ...
  # source://actionpack/7.2.0.alpha-5de585eae081be5f7b4484459fe0a2b737a9babclib/action_dispatch/routing/url_for.rb#99
