...
class Net::IMAP < ::Net::Protocol
  ...
  # source://net-imap//lib/net/imap.rb#1065
  ...
  # source://net-imap//lib/net/imap.rb#1159
  ...
  class << self
    ...
    # source://net-imap//lib/net/imap.rb#836
...
class Net::IMAP::SequenceSet
  ...
  #
  # source://net-imap//lib/net/imap/sequence_set.rb#659
  def +(other); end
  ...
  #
  # source://net-imap//lib/net/imap/sequence_set.rb#768
  def complement; end
  ...
  # * <tt>rhs ^ (lhs | rhs)</tt>
  #
  # source://net-imap//lib/net/imap/sequence_set.rb#688
  ...
  # Returns self
  #
  # source://net-imap//lib/net/imap/sequence_set.rb#1500
  def to_sequence_set; end
  ...
  # * <tt>(lhs & rhs) ^ (lhs ^ rhs)</tt>
  #
  # source://net-imap//lib/net/imap/sequence_set.rb#660
  def union(other); end
  ...
  # * <tt>(lhs ^ other) ^ (other ^ rhs)</tt>
  #
  # source://net-imap//lib/net/imap/sequence_set.rb#745
  def xor(other); end
