...
class ActiveRecord::Base
  ...
  # source://activerecord/8.0.0lib/active_record/reflection.rb#11
  ...
  # source://activemodel/8.0.0lib/active_model/validations.rb#50
  def _validators; end

  # source://activemodel/8.0.0lib/active_model/validations.rb#50
  def _validators?; end

  # source://activerecord/8.0.0lib/active_record/reflection.rb#12
  ...
  # source://activemodel/8.0.0lib/active_model/attribute_methods.rb#71
  def attribute_aliases; end

  # source://activemodel/8.0.0lib/active_model/attribute_methods.rb#71
  def attribute_aliases?; end

  # source://activemodel/8.0.0lib/active_model/attribute_methods.rb#72
  def attribute_method_patterns; end

  # source://activemodel/8.0.0lib/active_model/attribute_methods.rb#72
  def attribute_method_patterns?; end

  # source://activerecord/8.0.0lib/active_record/reflection.rb#13
  def automatic_scope_inversing; end

  # source://activerecord/8.0.0lib/active_record/reflection.rb#13
  def automatic_scope_inversing?; end

  # source://activerecord/8.0.0lib/active_record/reflection.rb#14
  def automatically_invert_plural_associations; end

  # source://activerecord/8.0.0lib/active_record/reflection.rb#14
  def automatically_invert_plural_associations?; end

  # source://activerecord/8.0.0lib/active_record/integration.rb#16
  def cache_timestamp_format; end

  # source://activerecord/8.0.0lib/active_record/integration.rb#16
  def cache_timestamp_format?; end

  # source://activerecord/8.0.0lib/active_record/integration.rb#24
  def cache_versioning; end

  # source://activerecord/8.0.0lib/active_record/integration.rb#24
  def cache_versioning?; end

  # source://activerecord/8.0.0lib/active_record/integration.rb#32
  def collection_cache_versioning; end

  # source://activerecord/8.0.0lib/active_record/integration.rb#32
  def collection_cache_versioning?; end

  # source://activerecord/8.0.0lib/active_record/model_schema.rb#183
  def column_for_attribute(name, &_arg1); end

  # source://activerecord/8.0.0lib/active_record/counter_cache.rb#10
  def counter_cached_association_names; end

  # source://activerecord/8.0.0lib/active_record/counter_cache.rb#10
  def counter_cached_association_names?; end

  # source://activerecord/8.0.0lib/active_record/core.rb#98
  def default_connection_handler; end

  # source://activerecord/8.0.0lib/active_record/core.rb#98
  def default_connection_handler?; end

  # source://activerecord/8.0.0lib/active_record/core.rb#100
  def default_role; end

  # source://activerecord/8.0.0lib/active_record/core.rb#100
  def default_role?; end

  # source://activerecord/8.0.0lib/active_record/scoping/default.rb#20
  def default_scope_override; end

  # source://activerecord/8.0.0lib/active_record/scoping/default.rb#19
  def default_scopes; end

  # source://activerecord/8.0.0lib/active_record/core.rb#102
  def default_shard; end

  # source://activerecord/8.0.0lib/active_record/core.rb#102
  def default_shard?; end

  # source://activerecord/8.0.0lib/active_record/enum.rb#167
  def defined_enums; end

  # source://activerecord/8.0.0lib/active_record/enum.rb#167
  def defined_enums?; end

  # source://activerecord/8.0.0lib/active_record/core.rb#47
  def destroy_association_async_batch_size; end

  # source://activerecord/8.0.0lib/active_record/core.rb#37
  def destroy_association_async_job(&_arg0); end

  # source://activerecord/8.0.0lib/active_record/encryption/encryptable_record.rb#11
  ...
  # source://activemodel/8.0.0lib/active_model/serializers/json.rb#15
  def include_root_in_json; end

  # source://activemodel/8.0.0lib/active_model/serializers/json.rb#15
  def include_root_in_json?; end

  # source://activerecord/8.0.0lib/active_record/locking/optimistic.rb#56
  def lock_optimistically; end

  # source://activerecord/8.0.0lib/active_record/locking/optimistic.rb#56
  def lock_optimistically?; end

  # source://activerecord/8.0.0lib/active_record/core.rb#22
  def logger; end

  # source://activerecord/8.0.0lib/active_record/core.rb#22
  def logger?; end

  # source://activemodel/8.0.0lib/active_model/naming.rb#255
  def model_name(&_arg0); end

  # source://activerecord/8.0.0lib/active_record/nested_attributes.rb#15
  def nested_attributes_options; end

  # source://activerecord/8.0.0lib/active_record/nested_attributes.rb#15
  def nested_attributes_options?; end

  # source://activerecord/8.0.0lib/active_record/normalization.rb#8
  ...
  # source://activemodel/8.0.0lib/active_model/conversion.rb#32
  def param_delimiter=(_arg0); end

  # source://activerecord/8.0.0lib/active_record/attribute_methods/dirty.rb#50
  def partial_inserts; end

  # source://activerecord/8.0.0lib/active_record/attribute_methods/dirty.rb#50
  def partial_inserts?; end

  # source://activerecord/8.0.0lib/active_record/attribute_methods/dirty.rb#49
  def partial_updates; end

  # source://activerecord/8.0.0lib/active_record/attribute_methods/dirty.rb#49
  def partial_updates?; end

  # source://activerecord/8.0.0lib/active_record/model_schema.rb#168
  def pluralize_table_names; end

  # source://activerecord/8.0.0lib/active_record/model_schema.rb#168
  def pluralize_table_names?; end

  # source://activerecord/8.0.0lib/active_record/model_schema.rb#163
  def primary_key_prefix_type; end

  # source://activerecord/8.0.0lib/active_record/model_schema.rb#163
  def primary_key_prefix_type?; end

  # source://activerecord/8.0.0lib/active_record/timestamp.rb#47
  ...
  # source://activerecord/8.0.0lib/active_record/signed_id.rb#13
  def signed_id_verifier_secret; end

  # source://activerecord/8.0.0lib/active_record/signed_id.rb#13
  def signed_id_verifier_secret?; end

  # source://activerecord/8.0.0lib/active_record/attribute_methods/time_zone_conversion.rb#61
  def skip_time_zone_conversion_for_attributes; end

  # source://activerecord/8.0.0lib/active_record/attribute_methods/time_zone_conversion.rb#61
  def skip_time_zone_conversion_for_attributes?; end

  # source://activerecord/8.0.0lib/active_record/inheritance.rb#43
  def store_full_class_name; end

  # source://activerecord/8.0.0lib/active_record/inheritance.rb#43
  def store_full_class_name?; end

  # source://activerecord/8.0.0lib/active_record/inheritance.rb#47
  def store_full_sti_class; end

  # source://activerecord/8.0.0lib/active_record/inheritance.rb#47
  def store_full_sti_class?; end

  # source://activerecord/8.0.0lib/active_record/model_schema.rb#164
  def table_name_prefix; end

  # source://activerecord/8.0.0lib/active_record/model_schema.rb#164
  def table_name_prefix?; end

  # source://activerecord/8.0.0lib/active_record/model_schema.rb#165
  def table_name_suffix; end

  # source://activerecord/8.0.0lib/active_record/model_schema.rb#165
  def table_name_suffix?; end

  # source://activerecord/8.0.0lib/active_record/attribute_methods/time_zone_conversion.rb#60
  def time_zone_aware_attributes; end

  # source://activerecord/8.0.0lib/active_record/attribute_methods/time_zone_conversion.rb#60
  def time_zone_aware_attributes?; end

  # source://activerecord/8.0.0lib/active_record/attribute_methods/time_zone_conversion.rb#62
  ...
  class << self
    ...
    # source://activerecord/8.0.0lib/active_record/readonly_attributes.rb#11
    def _attr_readonly?; end
    ...
    # source://activerecord/8.0.0lib/active_record/counter_cache.rb#9
    def _counter_cache_columns?; end
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#24
    def _destroy_association_async_job?; end
    ...
    # source://activemodel/8.0.0lib/active_model/callbacks.rb#144
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#121
    def application_record_class?; end

    # source://activemodel/8.0.0lib/active_model/callbacks.rb#137
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#141
    def asynchronous_queries_session; end

    # source://activerecord/8.0.0lib/active_record/core.rb#145
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#119
    def attributes_for_inspect?; end
    ...
    # source://activemodel/8.0.0lib/active_model/callbacks.rb#130
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#89
    def belongs_to_required_by_default?; end
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#77
    def configurations; end

    # source://activerecord/8.0.0lib/active_record/core.rb#71
    def configurations=(config); end

    # source://activerecord/8.0.0lib/active_record/core.rb#205
    def connected_to_stack; end

    # source://activerecord/8.0.0lib/active_record/core.rb#219
    def connection_class; end

    # source://activerecord/8.0.0lib/active_record/core.rb#215
    def connection_class=(b); end

    # source://activerecord/8.0.0lib/active_record/core.rb#223
    def connection_class?; end

    # source://activerecord/8.0.0lib/active_record/core.rb#227
    def connection_class_for_self; end

    # source://activerecord/8.0.0lib/active_record/core.rb#133
    def connection_handler; end

    # source://activerecord/8.0.0lib/active_record/core.rb#137
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#196
    def current_preventing_writes; end

    # source://activerecord/8.0.0lib/active_record/core.rb#159
    def current_role; end

    # source://activerecord/8.0.0lib/active_record/core.rb#177
    ...
    # source://activerecord/8.0.0lib/active_record/attribute_methods/serialization.rb#20
    def default_column_serializer?; end
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#27
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#87
    def enumerate_columns_in_select_statements?; end
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#94
    def has_many_inversing?; end
    ...
    # source://activerecord/8.0.0lib/active_record/model_schema.rb#170
    def immutable_strings_by_default?; end
    ...
    # source://activerecord/8.0.0lib/active_record/model_schema.rb#169
    def implicit_order_column?; end
    ...
    # source://activerecord/8.0.0lib/active_record/model_schema.rb#325
    def inheritance_column=(value); end

    # source://activerecord/8.0.0lib/active_record/model_schema.rb#172
    def inheritance_column?; end
    ...
    # source://activerecord/8.0.0lib/active_record/model_schema.rb#167
    def internal_metadata_table_name?; end

    # source://activerecord/8.0.0lib/active_record/store.rb#101
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#96
    def run_commit_callbacks_on_first_saved_instances_in_transaction?; end
    ...
    # source://activerecord/8.0.0lib/active_record/model_schema.rb#166
    def schema_migrations_table_name?; end
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#104
    def shard_selector?; end
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#91
    def strict_loading_by_default?; end
    ...
    # source://activerecord/8.0.0lib/active_record/core.rb#92
    def strict_loading_mode?; end

    # source://activerecord/8.0.0lib/active_record/core.rb#242
...
class ActiveStorage::Attached::Many < ::ActiveStorage::Attached
  ...
  # source://activesupport/8.0.0lib/active_support/delegation.rb#185
  ...
  # source://activesupport/8.0.0lib/active_support/delegation.rb#177
...
class ActiveStorage::Attached::One < ::ActiveStorage::Attached
  ...
  # source://activesupport/8.0.0lib/active_support/delegation.rb#164
  def method_missing(method, *_arg1, **_arg2, &_arg3); end
  ...
  # source://activesupport/8.0.0lib/active_support/delegation.rb#156
  def respond_to_missing?(name, include_private = T.unsafe(nil)); end
end
...
module ActiveStorage::Attachment::GeneratedAssociationMethods
  ...
  # source://activerecord/8.0.0lib/active_record/associations/builder/belongs_to.rb#146
  def blob_changed?; end

  # source://activerecord/8.0.0lib/active_record/associations/builder/belongs_to.rb#150
...
class ActiveStorage::Current < ::ActiveSupport::CurrentAttributes
  class << self
    ...
    # source://activesupport/8.0.0lib/active_support/current_attributes.rb#137
    def url_options; end

    # source://activesupport/8.0.0lib/active_support/current_attributes.rb#138
...
class ActiveStorage::FixtureSet
  ...
  # source://activesupport/8.0.0lib/active_support/testing/file_fixtures.rb#20
