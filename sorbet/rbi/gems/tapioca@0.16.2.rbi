...
class RBI::Tree < ::RBI::NodeWithComments
  # source://rbi/0.2.0lib/rbi/model.rb#121
  sig do
    params(
  ...
  # source://rbi/0.2.0lib/rbi/model.rb#128
  sig { params(node: ::RBI::Node).void }
  def <<(node); end

  # source://rbi/0.2.0lib/rbi/rewriters/add_sig_templates.rb#66
  sig { params(with_todo_comment: T::Boolean).void }
  def add_sig_templates!(with_todo_comment: T.unsafe(nil)); end

  # source://rbi/0.2.0lib/rbi/rewriters/annotate.rb#49
  ...
  # source://rbi/0.2.0lib/rbi/rewriters/deannotate.rb#41
  sig { params(annotation: ::String).void }
  def deannotate!(annotation); end

  # source://rbi/0.2.0lib/rbi/model.rb#134
  sig { returns(T::Boolean) }
  def empty?; end

  # source://rbi/0.2.0lib/rbi/rewriters/filter_versions.rb#118
  sig { params(version: ::Gem::Version).void }
  def filter_versions!(version); end

  # source://rbi/0.2.0lib/rbi/rewriters/flatten_singleton_methods.rb#60
  sig { void }
  def flatten_singleton_methods!; end

  # source://rbi/0.2.0lib/rbi/rewriters/flatten_visibilities.rb#60
  sig { void }
  def flatten_visibilities!; end

  # source://rbi/0.2.0lib/rbi/rewriters/group_nodes.rb#81
  sig { void }
  def group_nodes!; end

  # source://rbi/0.2.0lib/rbi/index.rb#68
  sig { returns(::RBI::Index) }
  def index; end

  # source://rbi/0.2.0lib/rbi/rewriters/merge_trees.rb#324
  sig do
    params(
      other: ::RBI::Tree,
      left_name: ::String,
  ...
  # source://rbi/0.2.0lib/rbi/rewriters/nest_non_public_members.rb#46
  sig { void }
  def nest_non_public_members!; end

  # source://rbi/0.2.0lib/rbi/rewriters/nest_singleton_methods.rb#36
  sig { void }
  def nest_singleton_methods!; end

  # source://rbi/0.2.0lib/rbi/rewriters/nest_top_level_members.rb#63
  sig { void }
  def nest_top_level_members!; end

  # source://rbi/0.2.0lib/rbi/model.rb#112
  sig { returns(T::Array[::RBI::Node]) }
  def nodes; end

  # source://rbi/0.2.0lib/rbi/rewriters/attr_to_methods.rb#53
  sig { void }
  def replace_attributes_with_methods!; end

  # source://rbi/0.2.0lib/rbi/rewriters/sort_nodes.rb#119
  sig { void }
  def sort_nodes!; end
