...
class URI::GID < ::URI::Generic
  ...
  # source://globalid/1.2.1lib/global_id/uri/gid.rb#107
  def deconstruct_keys(_keys); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#29
  def model_id; end
  ...
  # source://globalid/1.2.1lib/global_id/uri/gid.rb#102
  def to_s; end

  protected

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#118
  def query=(query); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#129
  def set_params(params); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#112
  def set_path(path); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#124
  def set_query(query); end

  private

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#136
  def check_host(host); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#141
  def check_path(path); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#146
  def check_scheme(scheme); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#195
  def parse_query_params(query); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#154
  def set_model_components(path, validate = T.unsafe(nil)); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#174
  def validate_component(component); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#188
  def validate_model_id(model_id_part); end

  # source://globalid/1.2.1lib/global_id/uri/gid.rb#181
  def validate_model_id_section(model_id, model_name); end

  class << self
    # source://globalid/1.2.1lib/global_id/uri/gid.rb#88
    def build(args); end

    # source://globalid/1.2.1lib/global_id/uri/gid.rb#72
    def create(app, model, params = T.unsafe(nil)); end

    # source://globalid/1.2.1lib/global_id/uri/gid.rb#64
    def parse(uri); end

    # source://globalid/1.2.1lib/global_id/uri/gid.rb#48
...
class URI::Source < ::URI::File
  # source://ruby-lsp/0.23.0lib/ruby_lsp/requests/support/source_uri.rb#69
  ...
  # source://ruby-lsp/0.23.0lib/ruby_lsp/requests/support/source_uri.rb#33
  sig { returns(T.nilable(::String)) }
  def gem_version; end
  ...
  # source://ruby-lsp/0.23.0lib/ruby_lsp/requests/support/source_uri.rb#59
  sig { params(v: T.nilable(::String)).void }
  def set_path(v); end

  # source://ruby-lsp/0.23.0lib/ruby_lsp/requests/support/source_uri.rb#81
  sig { returns(::String) }
  def to_s; end

  class << self
    # source://ruby-lsp/0.23.0lib/ruby_lsp/requests/support/source_uri.rb#46
    sig do
      params(
        gem_name: ::String,
