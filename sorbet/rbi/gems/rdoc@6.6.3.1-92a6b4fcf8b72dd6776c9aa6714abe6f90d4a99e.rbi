...
# source://rdoc/lib/rdoc/generator/snapper.rb#12
class RDoc::Generator::Snapper
  include ::ERB::Escape
  include ::ERB::Util
  include ::ActiveSupport::CoreExt::ERBUtil
  include ::ActiveSupport::CoreExt::ERBUtilPrivate

  # @return [Snapper] a new instance of Snapper
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#24
  def initialize(store, options); end

  # Returns the value of attribute base_dir.
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#21
  def base_dir; end

  # Directory where generated class HTML files live relative to the output dir
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#47
  def class_dir; end

  # Directory where generated class HTML files live relative to the output dir
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#52
  def file_dir; end

  # Create the directories the generated docs will live in if they don"t already exist
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#57
  def gen_sub_directories; end

  # Build the initial indices and output objects based on an array of TopLevel objects containing the extracted
  # information
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#63
  def generate; end

  # Returns the value of attribute store.
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#22
  def store; end
  ...
  # used directly.
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#387
  def assemble_template(body_file); end

  # Copy internal static files like CSS and JS from the generator's template
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#202
  def copy_internal_static_files; end

  # Copies static files from the static_path into the output directory
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#213
  def copy_static; end

  # Generates the nested links for classes and modules in the sidebar
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#131
  def create_sidebar_class_entries(klasses, rel_prefix); end

  # Creates the nested links for files in the sidebar
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#174
  def create_sidebar_page_entries(grouped_files, rel_prefix); end

  # Generate a documentation file for each class and module
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#264
  def generate_class_files; end

  # Generate a documentation file for each file
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#284
  def generate_file_files; end

  # Generate an index page which lists all the classes which are documented
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#239
  def generate_index; end

  # Generate a page file for +file+
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#333
  def generate_page(file); end

  # source://rdoc/lib/rdoc/generator/snapper.rb#75
  def generate_search_index; end

  # Generates the 404 page for the RDoc servlet
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#348
  def generate_servlet_not_found(message); end

  # Generates the servlet root page for the RDoc servlet
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#367
  def generate_servlet_root(installed); end
  ...
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#152
  def group_files; end

  # source://rdoc/lib/rdoc/generator/snapper.rb#121
  def gzip_js_files; end

  # Renders the ERb contained in +file_name+ relative to the template directory and returns the result based on the
  # current context.
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#409
  def render(file_name); end
  ...
  # An io will be yielded which must be captured by binding in the caller.
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#422
  def render_template(template_file, out_file = T.unsafe(nil)); end

  # Retrieves a cache template for +file+, if present, or fills the cache
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#455
  def template_for(file, page = T.unsafe(nil), klass = T.unsafe(nil)); end
  ...
  #
  # source://rdoc/lib/rdoc/generator/snapper.rb#444
  def template_result(template, context, template_file); end
end

# source://rdoc/lib/rdoc/generator/snapper.rb#19
RDoc::Generator::Snapper::DESCRIPTION = T.let(T.unsafe(nil), String)

# source://rdoc/lib/rdoc/generator/snapper.rb#17
RDoc::Generator::Snapper::GENERATOR_DIR = T.let(T.unsafe(nil), String)

# source://rdoc/lib/rdoc/generator/snapper.rb#18
RDoc::Generator::Snapper::VERSION = T.let(T.unsafe(nil), String)
