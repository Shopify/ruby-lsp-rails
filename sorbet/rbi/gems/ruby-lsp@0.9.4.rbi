...
class RubyLsp::Executor
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#709
  sig { void }
  def check_formatter_is_available; end

  # source://ruby-lsp/lib/ruby_lsp/executor.rb#408
  sig do
    params(
      uri: ::URI::Generic,
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#415
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#250
  sig do
    params(
      uri: ::URI::Generic,
      position: {line: ::Integer, character: ::Integer}
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#445
  sig do
    params(
      uri: ::URI::Generic
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#187
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#536
  sig { params(id: ::String).void }
  def end_progress(id); end

  # source://ruby-lsp/lib/ruby_lsp/executor.rb#268
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#549
  sig do
    params(
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#454
  sig do
    params(
      uri: ::URI::Generic,
      range: {start: {line: ::Integer, character: ::Integer}, end: {line: ::Integer, character: ::Integer}}
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#240
  sig do
    params(
      uri: ::URI::Generic,
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#235
...
class RubyLsp::Listener
  ...
  #
  # source://ruby-lsp/lib/ruby_lsp/listener.rb#39
  sig { overridable.params(other: RubyLsp::Listener[T.untyped]).returns(T.self_type) }
...
class RubyLsp::Requests::CodeLens < ::RubyLsp::Listener
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#79
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#153
  sig { override.params(other: RubyLsp::Listener[ResponseType]).returns(T.self_type) }
  def merge_response!(other); end

  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#124
  sig { params(node: ::SyntaxTree::CallNode).void }
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#143
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#241
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#203
...
class RubyLsp::Requests::Definition < ::RubyLsp::Listener
  extend T::Generic
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/definition.rb#138
...
class RubyLsp::Requests::DocumentSymbol < ::RubyLsp::Listener
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/document_symbol.rb#100
  sig { params(node: ::SyntaxTree::ClassDeclaration).void }
  def after_class(node); end

  # source://ruby-lsp/lib/ruby_lsp/requests/document_symbol.rb#153
  sig { params(node: ::SyntaxTree::DefNode).void }
  ...
  #
  # source://ruby-lsp/lib/ruby_lsp/requests/document_symbol.rb#84
  sig { override.params(other: RubyLsp::Listener[ResponseType]).returns(T.self_type) }
  def merge_response!(other); end
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/document_symbol.rb#105
  sig { params(node: ::SyntaxTree::Command).void }
  def on_command(node); end
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/document_symbol.rb#131
  sig { params(node: ::SyntaxTree::DefNode).void }
  def on_def(node); end
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/document_symbol.rb#212
  sig do
    params(
      name: ::String,
      kind: ::Integer,
...
class RubyLsp::Requests::Hover < ::RubyLsp::Listener
  ...
  #
  # source://ruby-lsp/lib/ruby_lsp/requests/hover.rb#57
  sig { override.params(other: RubyLsp::Listener[ResponseType]).returns(T.self_type) }
  def merge_response!(other); end
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/hover.rb#71
  sig { params(node: ::SyntaxTree::ConstPathRef).void }
  def on_const_path_ref(node); end
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/hover.rb#88
...
class RubyLsp::Requests::PathCompletion < ::RubyLsp::Listener
  ...
  sig { params(index: ::RubyIndexer::Index, emitter: ::RubyLsp::EventEmitter, message_queue: ::Thread::Queue).void }
  def initialize(index, emitter, message_queue); end
