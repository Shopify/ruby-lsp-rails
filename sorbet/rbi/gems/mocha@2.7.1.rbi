...
# pkg:gem/mocha#lib/mocha/inspect.rb:56
class Array
  include ::Enumerable
...
# pkg:gem/mocha#lib/mocha/inspect.rb:68
class Date
  include ::Comparable
  include ::Mocha::Inspect::DateMethods
end

# pkg:gem/mocha#lib/mocha/inspect.rb:60
class Hash
  include ::Enumerable
...
# pkg:gem/mocha#lib/mocha/version.rb:1
module Mocha
  class << self
    # @private
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:25
    ...
    #   end
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:20
    def configure; end
  end
end
...
#
# pkg:gem/mocha#lib/mocha/api.rb:34
module Mocha::API
  include ::Mocha::ParameterMatchers
  include ::Mocha::Hooks
  ...
  #   end
  #
  # pkg:gem/mocha#lib/mocha/api.rb:69
  ...
  #   end
  #
  # pkg:gem/mocha#lib/mocha/api.rb:170
  ...
  #
  # pkg:gem/mocha#lib/mocha/api.rb:207
  def states(name); end
  ...
  #   end
  #
  # pkg:gem/mocha#lib/mocha/api.rb:96
  ...
  #   end
  #
  # pkg:gem/mocha#lib/mocha/api.rb:123
  def stub_everything(*arguments); end

  class << self
    # @private
    #
    # pkg:gem/mocha#lib/mocha/api.rb:45
    def extended(mod); end

    # @private
    #
    # pkg:gem/mocha#lib/mocha/api.rb:39
    def included(_mod); end
  end
end

# pkg:gem/mocha#lib/mocha/any_instance_method.rb:4
class Mocha::AnyInstanceMethod < ::Mocha::StubbedMethod
  private

  # pkg:gem/mocha#lib/mocha/any_instance_method.rb:7
  def mock_owner; end

  # pkg:gem/mocha#lib/mocha/any_instance_method.rb:15
  def original_method_owner; end

  # pkg:gem/mocha#lib/mocha/any_instance_method.rb:11
  def stubbee_method(method_name); end
end

# pkg:gem/mocha#lib/mocha/receivers.rb:19
class Mocha::AnyInstanceReceiver
  # pkg:gem/mocha#lib/mocha/receivers.rb:20
  def initialize(klass); end

  # pkg:gem/mocha#lib/mocha/receivers.rb:24
  def mocks; end
end

# pkg:gem/mocha#lib/mocha/argument_iterator.rb:2
class Mocha::ArgumentIterator
  # pkg:gem/mocha#lib/mocha/argument_iterator.rb:3
  def initialize(argument); end

  # pkg:gem/mocha#lib/mocha/argument_iterator.rb:7
  def each; end
end

# pkg:gem/mocha#lib/mocha/backtrace_filter.rb:2
class Mocha::BacktraceFilter
  # pkg:gem/mocha#lib/mocha/backtrace_filter.rb:5
  def initialize(lib_directory = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/backtrace_filter.rb:9
  def filtered(backtrace); end
end

# pkg:gem/mocha#lib/mocha/backtrace_filter.rb:3
Mocha::BacktraceFilter::LIB_DIRECTORY = T.let(T.unsafe(nil), String)

# pkg:gem/mocha#lib/mocha/block_matcher.rb:2
module Mocha::BlockMatchers; end

# pkg:gem/mocha#lib/mocha/block_matcher.rb:11
class Mocha::BlockMatchers::BlockGiven
  # pkg:gem/mocha#lib/mocha/block_matcher.rb:12
  def match?(actual_block); end

  # pkg:gem/mocha#lib/mocha/block_matcher.rb:16
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/block_matcher.rb:21
class Mocha::BlockMatchers::NoBlockGiven
  # pkg:gem/mocha#lib/mocha/block_matcher.rb:22
  def match?(actual_block); end

  # pkg:gem/mocha#lib/mocha/block_matcher.rb:26
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/block_matcher.rb:3
class Mocha::BlockMatchers::OptionalBlock
  # pkg:gem/mocha#lib/mocha/block_matcher.rb:4
  def match?(_actual_block); end

  # pkg:gem/mocha#lib/mocha/block_matcher.rb:8
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/cardinality.rb:2
class Mocha::Cardinality
  # pkg:gem/mocha#lib/mocha/cardinality.rb:5
  def initialize(required = T.unsafe(nil), maximum = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:29
  def <<(invocation); end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:83
  def actual_invocations; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:53
  def allowed_any_number_of_times?; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:62
  def anticipated_times; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:14
  def at_least(count); end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:18
  def at_most(count); end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:10
  def exactly(count); end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:33
  def invocations_allowed?; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:37
  def invocations_never_allowed?; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:79
  def invoked_times; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:45
  def needs_verifying?; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:41
  def satisfied?; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:22
  def times(range_or_count); end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:57
  def used?; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:49
  def verified?; end

  protected

  # pkg:gem/mocha#lib/mocha/cardinality.rb:91
  def count(number); end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:106
  def infinite?(number); end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:89
  def maximum; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:89
  def required; end

  # pkg:gem/mocha#lib/mocha/cardinality.rb:100
  def update(required, maximum); end
end

# pkg:gem/mocha#lib/mocha/cardinality.rb:3
Mocha::Cardinality::INFINITY = T.let(T.unsafe(nil), Float)

# pkg:gem/mocha#lib/mocha/central.rb:2
class Mocha::Central
  # pkg:gem/mocha#lib/mocha/central.rb:20
  def initialize; end

  # pkg:gem/mocha#lib/mocha/central.rb:24
  def stub(method); end

  # pkg:gem/mocha#lib/mocha/central.rb:18
  def stubba_methods; end

  # pkg:gem/mocha#lib/mocha/central.rb:18
  def stubba_methods=(_arg0); end

  # pkg:gem/mocha#lib/mocha/central.rb:30
  def unstub(method); end

  # pkg:gem/mocha#lib/mocha/central.rb:36
  def unstub_all; end
end

# pkg:gem/mocha#lib/mocha/central.rb:3
class Mocha::Central::Null < ::Mocha::Central
  # pkg:gem/mocha#lib/mocha/central.rb:4
  def initialize(&block); end

  # pkg:gem/mocha#lib/mocha/central.rb:9
  def stub(*_arg0); end

  # pkg:gem/mocha#lib/mocha/central.rb:13
  def unstub(*_arg0); end
end

# pkg:gem/mocha#lib/mocha/change_state_side_effect.rb:2
class Mocha::ChangeStateSideEffect
  # pkg:gem/mocha#lib/mocha/change_state_side_effect.rb:3
  def initialize(state); end

  # pkg:gem/mocha#lib/mocha/change_state_side_effect.rb:11
  def mocha_inspect; end

  # pkg:gem/mocha#lib/mocha/change_state_side_effect.rb:7
  def perform; end
end

# Methods added to all classes to allow mocking and stubbing on real (i.e. non-mock) objects.
#
# pkg:gem/mocha#lib/mocha/class_methods.rb:6
module Mocha::ClassMethods
  # pkg:gem/mocha#lib/mocha/class_methods.rb:60
  def __method_exists__?(method, include_public_methods = T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/class_methods.rb:54
  ...
  #
  # pkg:gem/mocha#lib/mocha/class_methods.rb:45
  def any_instance; end
end

# @private
#
# pkg:gem/mocha#lib/mocha/class_methods.rb:8
class Mocha::ClassMethods::AnyInstance
  # pkg:gem/mocha#lib/mocha/class_methods.rb:9
  def initialize(klass); end

  # pkg:gem/mocha#lib/mocha/class_methods.rb:13
  def mocha(instantiate = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/class_methods.rb:29
  def respond_to?(symbol, include_all = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/class_methods.rb:25
  def stubba_class; end

  # pkg:gem/mocha#lib/mocha/class_methods.rb:21
  def stubba_method; end

  # pkg:gem/mocha#lib/mocha/class_methods.rb:33
...
#   end
#
# pkg:gem/mocha#lib/mocha/configuration.rb:40
class Mocha::Configuration
  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:56
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:251
  def display_matching_invocations_on_failure=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:256
  def display_matching_invocations_on_failure?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:66
  def merge(other); end
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:297
  def strict_keyword_argument_matching=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:303
  def strict_keyword_argument_matching?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:222
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:212
  def stubbing_method_on_nil=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:128
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:123
  def stubbing_method_on_non_mock_object=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:95
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:90
  def stubbing_method_unnecessarily=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:161
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:156
  def stubbing_non_existent_method=(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:195
  ...
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:190
  def stubbing_non_public_method=(value); end

  protected

  # pkg:gem/mocha#lib/mocha/configuration.rb:52
  def options; end
  ...
  # @private
  #
  # pkg:gem/mocha#lib/mocha/configuration.rb:61
  def initialize_copy(other); end

  class << self
    # @private
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:334
    def configuration; end
    ...
    #   end
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:325
    def override(temporary_options); end

    # @private
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:309
    ...
    # @private
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:341
    def change_config(action, new_value, &block); end

    # @private
    #
    # pkg:gem/mocha#lib/mocha/configuration.rb:350
...
# @private
#
# pkg:gem/mocha#lib/mocha/configuration.rb:42
Mocha::Configuration::DEFAULTS = T.let(T.unsafe(nil), Hash)

# pkg:gem/mocha#lib/mocha/debug.rb:2
module Mocha::Debug
  class << self
    # pkg:gem/mocha#lib/mocha/debug.rb:5
    def puts(message); end
  end
end

# pkg:gem/mocha#lib/mocha/debug.rb:3
Mocha::Debug::OPTIONS = T.let(T.unsafe(nil), Array)

# pkg:gem/mocha#lib/mocha/names.rb:32
class Mocha::DefaultName
  # pkg:gem/mocha#lib/mocha/names.rb:33
  def initialize(mock); end

  # pkg:gem/mocha#lib/mocha/names.rb:37
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/receivers.rb:36
class Mocha::DefaultReceiver
  # pkg:gem/mocha#lib/mocha/receivers.rb:37
  def initialize(mock); end

  # pkg:gem/mocha#lib/mocha/receivers.rb:41
  def mocks; end
end

# pkg:gem/mocha#lib/mocha/deprecation.rb:4
...
# pkg:gem/mocha#lib/mocha/detection/minitest.rb:2
module Mocha::Detection; end

# pkg:gem/mocha#lib/mocha/detection/minitest.rb:3
module Mocha::Detection::Minitest
  class << self
    # pkg:gem/mocha#lib/mocha/detection/minitest.rb:4
    def testcase; end

    # pkg:gem/mocha#lib/mocha/detection/minitest.rb:12
    def version; end
  end
end
...
# @private
#
# pkg:gem/mocha#lib/mocha/error_with_filtered_backtrace.rb:5
class Mocha::ErrorWithFilteredBacktrace < ::StandardError
  # @private
  #
  # pkg:gem/mocha#lib/mocha/error_with_filtered_backtrace.rb:7
  def initialize(message = T.unsafe(nil), backtrace = T.unsafe(nil)); end
end

# pkg:gem/mocha#lib/mocha/exception_raiser.rb:2
class Mocha::ExceptionRaiser
  # pkg:gem/mocha#lib/mocha/exception_raiser.rb:3
  def initialize(exception, message); end

  # pkg:gem/mocha#lib/mocha/exception_raiser.rb:8
  def evaluate(invocation); end
end

# Methods on expectations returned from {Mock#expects}, {Mock#stubs}, {ObjectMethods#expects} and {ObjectMethods#stubs}.
#
# pkg:gem/mocha#lib/mocha/expectation.rb:19
class Mocha::Expectation
  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:618
  def initialize(mock, expected_method_name, backtrace = T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:637
  def add_in_sequence_ordering_constraint(sequence); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:632
  def add_ordering_constraint(ordering_constraint); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:642
  ...
  #   # => verify fails
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:134
  ...
  #   # => verify fails
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:152
  ...
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:170
  ...
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:188
  def at_most_once; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:615
  def backtrace; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:730
  ...
  #   egg.expects(:eat).in_sequence(breakfast)
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:609
  def in_sequence(sequence, *sequences); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:706
  def inspect; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:673
  def invocations_allowed?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:678
  def invocations_never_allowed?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:688
  def invoke(invocation); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:667
  def match?(invocation, ignoring_order: T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:662
  def matches_method?(method_name); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:723
  def method_signature; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:713
  def mocha_inspect; end
  ...
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:396
  ...
  #   # => verify succeeds
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:114
  def never; end
  ...
  #   # => verify fails
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:97
  def once; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:657
  def ordering_constraints_not_allowing_invocation_now; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:647
  ...
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:483
  ...
  #   y # => 2
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:443
  def returns(*values); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:683
  def satisfied?; end
  ...
  #   radio.expects(:switch_off).then(power.is('off'))
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:557
  ...
  #   object.expected_method # => 3
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:522
  ...
  #   # => verify fails
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:46
  def times(range); end
  ...
  #   # => verify fails
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:72
  def twice; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:701
  def used?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:695
  ...
  #   radio.expects(:switch_off).then(power.is('off'))
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:581
  ...
  #   end
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:290
  ...
  #   # => verify fails
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:310
  ...
  #   # => verify fails
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:329
  ...
  #   sum # => 2
  #
  # pkg:gem/mocha#lib/mocha/expectation.rb:368
...
#
# pkg:gem/mocha#lib/mocha/expectation_error.rb:7
...
#
# pkg:gem/mocha#lib/mocha/expectation_error_factory.rb:12
class Mocha::ExpectationErrorFactory
  class << self
    # @private
    #
    # pkg:gem/mocha#lib/mocha/expectation_error_factory.rb:26
    ...
    #
    # pkg:gem/mocha#lib/mocha/expectation_error_factory.rb:23
...
# pkg:gem/mocha#lib/mocha/expectation_list.rb:2
class Mocha::ExpectationList
  # pkg:gem/mocha#lib/mocha/expectation_list.rb:3
  def initialize(expectations = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:52
  def +(other); end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:7
  def add(expectation); end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:48
  def any?; end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:44
  def length; end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:20
  def match(invocation, ignoring_order: T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:24
  def match_allowing_invocation(invocation); end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:28
  def match_never_allowing_invocation(invocation); end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:16
  def matches_method?(method_name); end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:56
  def matching_expectations(invocation, ignoring_order: T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:12
  def remove_all_matching_method(method_name); end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:36
  def to_a; end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:40
  def to_set; end

  # pkg:gem/mocha#lib/mocha/expectation_list.rb:32
  def verified?(assertion_counter = T.unsafe(nil)); end
end
...
# @see Mocha::API
#
# pkg:gem/mocha#lib/mocha/hooks.rb:18
module Mocha::Hooks
  ...
  #
  # pkg:gem/mocha#lib/mocha/hooks.rb:22
  def mocha_setup; end
  ...
  #
  # pkg:gem/mocha#lib/mocha/hooks.rb:38
  ...
  #
  # pkg:gem/mocha#lib/mocha/hooks.rb:44
  ...
  #
  # pkg:gem/mocha#lib/mocha/hooks.rb:31
  def mocha_verify(assertion_counter = T.unsafe(nil)); end
end

# pkg:gem/mocha#lib/mocha/names.rb:12
class Mocha::ImpersonatingAnyInstanceName
  # pkg:gem/mocha#lib/mocha/names.rb:13
  def initialize(klass); end

  # pkg:gem/mocha#lib/mocha/names.rb:17
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/names.rb:2
class Mocha::ImpersonatingName
  # pkg:gem/mocha#lib/mocha/names.rb:3
  def initialize(object); end

  # pkg:gem/mocha#lib/mocha/names.rb:7
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/in_state_ordering_constraint.rb:2
class Mocha::InStateOrderingConstraint
  # pkg:gem/mocha#lib/mocha/in_state_ordering_constraint.rb:3
  def initialize(state_predicate); end

  # pkg:gem/mocha#lib/mocha/in_state_ordering_constraint.rb:7
  def allows_invocation_now?; end

  # pkg:gem/mocha#lib/mocha/in_state_ordering_constraint.rb:11
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/inspect.rb:4
module Mocha::Inspect; end

# pkg:gem/mocha#lib/mocha/inspect.rb:13
module Mocha::Inspect::ArrayMethods
  # pkg:gem/mocha#lib/mocha/inspect.rb:14
  def mocha_inspect(wrapped = T.unsafe(nil)); end
end

# pkg:gem/mocha#lib/mocha/inspect.rb:44
module Mocha::Inspect::DateMethods
  # pkg:gem/mocha#lib/mocha/inspect.rb:45
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/inspect.rb:20
module Mocha::Inspect::HashMethods
  # pkg:gem/mocha#lib/mocha/inspect.rb:21
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/inspect.rb:5
module Mocha::Inspect::ObjectMethods
  # pkg:gem/mocha#lib/mocha/inspect.rb:6
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/inspect.rb:38
module Mocha::Inspect::TimeMethods
  # pkg:gem/mocha#lib/mocha/inspect.rb:39
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/instance_method.rb:4
class Mocha::InstanceMethod < ::Mocha::StubbedMethod
  private

  # pkg:gem/mocha#lib/mocha/instance_method.rb:7
  def mock_owner; end

  # pkg:gem/mocha#lib/mocha/instance_method.rb:15
  def original_method_owner; end

  # pkg:gem/mocha#lib/mocha/instance_method.rb:11
  def stubbee_method(method_name); end
end

# pkg:gem/mocha#lib/mocha/integration/assertion_counter.rb:2
module Mocha::Integration; end

# pkg:gem/mocha#lib/mocha/integration/assertion_counter.rb:3
class Mocha::Integration::AssertionCounter
  # pkg:gem/mocha#lib/mocha/integration/assertion_counter.rb:4
  def initialize(test_case); end

  # pkg:gem/mocha#lib/mocha/integration/assertion_counter.rb:8
  def increment; end
end

# pkg:gem/mocha#lib/mocha/integration/minitest/adapter.rb:7
module Mocha::Integration::Minitest
  class << self
    # pkg:gem/mocha#lib/mocha/integration/minitest.rb:8
    def activate; end
  end
end
...
#
# pkg:gem/mocha#lib/mocha/integration/minitest/adapter.rb:11
module Mocha::Integration::Minitest::Adapter
  ...
  # @private
  #
  # pkg:gem/mocha#lib/mocha/integration/minitest/adapter.rb:45
  def after_teardown; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/integration/minitest/adapter.rb:30
  def before_setup; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/integration/minitest/adapter.rb:36
  def before_teardown; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/integration/minitest/adapter.rb:51
  def mocha_test_name; end

  class << self
    # @private
    #
    # pkg:gem/mocha#lib/mocha/integration/minitest/adapter.rb:15
    def applicable_to?(minitest_version); end

    # @private
    #
    # pkg:gem/mocha#lib/mocha/integration/minitest/adapter.rb:20
    def description; end

    # @private
    #
    # pkg:gem/mocha#lib/mocha/integration/minitest/adapter.rb:25
    def included(_mod); end
  end
end

# pkg:gem/mocha#lib/mocha/invocation.rb:8
class Mocha::Invocation
  # pkg:gem/mocha#lib/mocha/invocation.rb:11
  def initialize(mock, method_name, arguments = T.unsafe(nil), block = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/invocation.rb:41
  def arguments; end

  # pkg:gem/mocha#lib/mocha/invocation.rb:9
  def block; end

  # pkg:gem/mocha#lib/mocha/invocation.rb:20
  def call(yield_parameters = T.unsafe(nil), return_values = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/invocation.rb:45
  def call_description; end

  # pkg:gem/mocha#lib/mocha/invocation.rb:61
  def full_description; end

  # pkg:gem/mocha#lib/mocha/invocation.rb:9
  def method_name; end

  # pkg:gem/mocha#lib/mocha/invocation.rb:33
  def raised(exception); end

  # pkg:gem/mocha#lib/mocha/invocation.rb:55
  def result_description; end

  # pkg:gem/mocha#lib/mocha/invocation.rb:29
  def returned(value); end

  # pkg:gem/mocha#lib/mocha/invocation.rb:51
  def short_call_description; end

  # pkg:gem/mocha#lib/mocha/invocation.rb:37
  def threw(tag, value); end

  private

  # pkg:gem/mocha#lib/mocha/invocation.rb:67
  def argument_description; end
end

# pkg:gem/mocha#lib/mocha/logger.rb:2
class Mocha::Logger
  # pkg:gem/mocha#lib/mocha/logger.rb:3
  def initialize(io); end

  # pkg:gem/mocha#lib/mocha/logger.rb:7
  def warn(message); end
end

# pkg:gem/mocha#lib/mocha/method_matcher.rb:2
class Mocha::MethodMatcher
  # pkg:gem/mocha#lib/mocha/method_matcher.rb:5
  def initialize(expected_method_name); end

  # pkg:gem/mocha#lib/mocha/method_matcher.rb:3
  def expected_method_name; end

  # pkg:gem/mocha#lib/mocha/method_matcher.rb:9
  def match?(actual_method_name); end

  # pkg:gem/mocha#lib/mocha/method_matcher.rb:13
  def mocha_inspect; end
end
...
#
# pkg:gem/mocha#lib/mocha/mock.rb:79
class Mocha::Mock
  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:279
  def initialize(mockery, name = T.unsafe(nil), receiver = T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:303
  def __expectations__; end

  # pkg:gem/mocha#lib/mocha/mock.rb:293
  def __expects__(method_name_or_hash, backtrace = T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:363
  def __expire__(origin); end

  # pkg:gem/mocha#lib/mocha/mock.rb:297
  def __singleton_class__; end

  # pkg:gem/mocha#lib/mocha/mock.rb:295
  def __stubs__(method_name_or_hash, backtrace = T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:358
  def __verified__?(assertion_counter = T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:313
  def all_expectations; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:383
  def any_expectations?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:378
  def ensure_method_not_already_defined(method_name); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:291
  ...
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:114
  def expects(method_name_or_hash, backtrace = T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:324
  def handle_method_call(symbol, arguments, block); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:373
  def inspect; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:318
  def method_missing(symbol, *arguments, **_arg2, &block); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:368
  def mocha_inspect; end

  # pkg:gem/mocha#lib/mocha/mock.rb:299
  def quacks_like(responder); end

  # pkg:gem/mocha#lib/mocha/mock.rb:300
  ...
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:241
  ...
  #   sheep.foo # => raises NoMethodError exception
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:274
  def responds_like_instance_of(responder_class); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:308
  ...
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:153
  ...
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:186
  def unstub(*method_names); end

  private

  # pkg:gem/mocha#lib/mocha/mock.rb:410
  def check_expiry; end

  # pkg:gem/mocha#lib/mocha/mock.rb:404
  def check_responder_responds_to(symbol); end

  # pkg:gem/mocha#lib/mocha/mock.rb:389
  def raise_unexpected_invocation_error(invocation, matching_expectation); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/mock.rb:349
  def respond_to_missing?(symbol, _include_all); end
end

# pkg:gem/mocha#lib/mocha/mockery.rb:13
class Mocha::Mockery
  # pkg:gem/mocha#lib/mocha/mockery.rb:138
  def logger; end

  # pkg:gem/mocha#lib/mocha/mockery.rb:136
  def logger=(_arg0); end

  # pkg:gem/mocha#lib/mocha/mockery.rb:116
  def mocha_inspect; end

  # pkg:gem/mocha#lib/mocha/mockery.rb:66
  def mock_impersonating(object); end

  # pkg:gem/mocha#lib/mocha/mockery.rb:70
  def mock_impersonating_any_instance_of(klass); end

  # pkg:gem/mocha#lib/mocha/mockery.rb:104
  def mocks; end

  # pkg:gem/mocha#lib/mocha/mockery.rb:58
  ...
  # pkg:gem/mocha#lib/mocha/mockery.rb:112
  def sequences; end

  # pkg:gem/mocha#lib/mocha/mockery.rb:108
  def state_machines; end

  # pkg:gem/mocha#lib/mocha/mockery.rb:100
  def stubba; end

  # pkg:gem/mocha#lib/mocha/mockery.rb:94
  def teardown(origin = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/mockery.rb:62
  ...
  # pkg:gem/mocha#lib/mocha/mockery.rb:165
  def add_mock(mock); end

  # pkg:gem/mocha#lib/mocha/mockery.rb:170
  def add_state_machine(state_machine); end

  # pkg:gem/mocha#lib/mocha/mockery.rb:144
  ...
  # pkg:gem/mocha#lib/mocha/mockery.rb:161
  def satisfied_expectations; end

  # pkg:gem/mocha#lib/mocha/mockery.rb:157
  def unsatisfied_expectations; end

  class << self
    # pkg:gem/mocha#lib/mocha/mockery.rb:36
    def instance; end

    # pkg:gem/mocha#lib/mocha/mockery.rb:40
    def setup; end

    # pkg:gem/mocha#lib/mocha/mockery.rb:51
    def teardown(origin = T.unsafe(nil)); end

    # pkg:gem/mocha#lib/mocha/mockery.rb:47
    def verify(*args); end
  end
end

# pkg:gem/mocha#lib/mocha/mockery.rb:14
class Mocha::Mockery::Null < ::Mocha::Mockery
  # pkg:gem/mocha#lib/mocha/mockery.rb:15
  def add_mock(*_arg0); end

  # pkg:gem/mocha#lib/mocha/mockery.rb:19
  def add_state_machine(*_arg0); end

  # pkg:gem/mocha#lib/mocha/mockery.rb:23
  def stubba; end

  private

  # pkg:gem/mocha#lib/mocha/mockery.rb:29
  def raise_not_initialized_error; end
end

# pkg:gem/mocha#lib/mocha/names.rb:22
class Mocha::Name
  # pkg:gem/mocha#lib/mocha/names.rb:23
  def initialize(name); end

  # pkg:gem/mocha#lib/mocha/names.rb:27
  def mocha_inspect; end
end
...
# context of a test.
#
# pkg:gem/mocha#lib/mocha/not_initialized_error.rb:6
...
#
# pkg:gem/mocha#lib/mocha/object_methods.rb:10
module Mocha::ObjectMethods
  # @private
  #
  # pkg:gem/mocha#lib/mocha/object_methods.rb:12
  ...
  # @see Mock#expects
  #
  # pkg:gem/mocha#lib/mocha/object_methods.rb:71
  def expects(expected_methods_vs_return_values); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/object_methods.rb:15
  def mocha(instantiate = T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/object_methods.rb:24
  def reset_mocha; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/object_methods.rb:39
  def stubba_class; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/object_methods.rb:29
  def stubba_method; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/object_methods.rb:34
  def stubba_object; end
  ...
  # @see Mock#stubs
  #
  # pkg:gem/mocha#lib/mocha/object_methods.rb:120
  ...
  #   multiplier.unstub(:triple)
  #
  # pkg:gem/mocha#lib/mocha/object_methods.rb:161
  def unstub(*method_names); end
end

# pkg:gem/mocha#lib/mocha/receivers.rb:2
class Mocha::ObjectReceiver
  # pkg:gem/mocha#lib/mocha/receivers.rb:3
  def initialize(object); end

  # pkg:gem/mocha#lib/mocha/receivers.rb:7
  def mocks; end
end

# Used as parameters for {Expectation#with} to restrict the parameter values which will match the expectation. Can be nested.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers.rb:3
module Mocha::ParameterMatchers
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/not.rb:24
  def Not(matcher); end
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/all_of.rb:23
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/any_of.rb:29
  ...
  #   # no error raised
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/any_parameters.rb:21
  ...
  #   # no error raised
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/anything.rb:18
  def anything; end
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/equals.rb:24
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/equivalent_uri.rb:25
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_entries.rb:26
  ...
  #   # error raised, because method_1 was not called with Hash containing entry: 'key_1' => 1
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_entry.rb:43
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_key.rb:24
  def has_key(key); end
  ...
  #   # error raised, because method_1 was not called with Hash containing key: :key_1
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_keys.rb:24
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_value.rb:24
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/includes.rb:63
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/instance_of.rb:24
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/is_a.rb:25
  def is_a(klass); end
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/kind_of.rb:24
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/optionally.rb:33
  ...
  #   # regular expression
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/regexp_matches.rb:24
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/responds_with.rb:37
  ...
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/yaml_equivalent.rb:24
  ...
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_entry.rb:82
  def parse_option(option); end
end

# Parameter matcher which combines a number of other matchers using a logical AND.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/all_of.rb:28
class Mocha::ParameterMatchers::AllOf < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/all_of.rb:30
  def initialize(*matchers); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/all_of.rb:35
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/all_of.rb:41
  def mocha_inspect; end
end

# Parameter matcher which combines a number of other matchers using a logical OR.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/any_of.rb:34
class Mocha::ParameterMatchers::AnyOf < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/any_of.rb:36
  def initialize(*matchers); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/any_of.rb:41
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/any_of.rb:47
  def mocha_inspect; end
end

# Parameter matcher which always matches whatever the parameters.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/any_parameters.rb:26
class Mocha::ParameterMatchers::AnyParameters < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/any_parameters.rb:28
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/any_parameters.rb:36
  def mocha_inspect; end
end

# Parameter matcher which always matches a single parameter.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/anything.rb:23
class Mocha::ParameterMatchers::Anything < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/anything.rb:25
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/anything.rb:31
  def mocha_inspect; end
end
...
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/base.rb:4
class Mocha::ParameterMatchers::Base
  ...
  #   object.run(foo: 'foovalue', bar: 'barvalue)
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/base.rb:25
  def &(other); end
  ...
  #   object.run(3) # fails
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/base.rb:55
  def |(other); end
end

# Parameter matcher which matches when actual parameter equals expected value.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/equals.rb:29
class Mocha::ParameterMatchers::Equals < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/equals.rb:31
  def initialize(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/equals.rb:36
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/equals.rb:42
  def mocha_inspect; end
end

# Parameter matcher which matches URIs with equivalent query strings.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/equivalent_uri.rb:30
class Mocha::ParameterMatchers::EquivalentUri < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/equivalent_uri.rb:32
  def initialize(uri); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/equivalent_uri.rb:37
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/equivalent_uri.rb:44
  def mocha_inspect; end
  ...
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/equivalent_uri.rb:51
  def explode(uri); end
end

# Parameter matcher which matches when actual parameter contains all expected +Hash+ entries.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/has_entries.rb:31
class Mocha::ParameterMatchers::HasEntries < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_entries.rb:33
  def initialize(entries, exact: T.unsafe(nil)); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_entries.rb:39
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_entries.rb:50
  def mocha_inspect; end
end

# Parameter matcher which matches when actual parameter contains expected +Hash+ entry.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/has_entry.rb:58
class Mocha::ParameterMatchers::HasEntry < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_entry.rb:60
  def initialize(key, value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_entry.rb:66
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_entry.rb:74
  def mocha_inspect; end
end

# Parameter matcher which matches when actual parameter contains +Hash+ entry with expected key.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/has_key.rb:29
class Mocha::ParameterMatchers::HasKey < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_key.rb:31
  def initialize(key); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_key.rb:36
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_key.rb:43
  def mocha_inspect; end
end

# Parameter matcher which matches when actual parameter contains +Hash+ with all expected keys.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/has_keys.rb:29
class Mocha::ParameterMatchers::HasKeys < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_keys.rb:31
  def initialize(*keys); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_keys.rb:38
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_keys.rb:48
  def mocha_inspect; end
end

# Parameter matcher which matches when actual parameter contains +Hash+ entry with expected value.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/has_value.rb:29
class Mocha::ParameterMatchers::HasValue < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_value.rb:31
  def initialize(value); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_value.rb:36
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/has_value.rb:43
  def mocha_inspect; end
end

# Parameter matcher which matches when actual parameter includes expected values.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/includes.rb:68
class Mocha::ParameterMatchers::Includes < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/includes.rb:70
  def initialize(*items); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/includes.rb:76
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/includes.rb:96
  def mocha_inspect; end
end

# @private
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/instance_methods.rb:8
module Mocha::ParameterMatchers::InstanceMethods
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/instance_methods.rb:10
...
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/instance_of.rb:29
class Mocha::ParameterMatchers::InstanceOf < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/instance_of.rb:31
  def initialize(klass); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/instance_of.rb:36
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/instance_of.rb:42
  def mocha_inspect; end
end

# Parameter matcher which matches when actual parameter is a specific class.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/is_a.rb:30
class Mocha::ParameterMatchers::IsA < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/is_a.rb:32
  def initialize(klass); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/is_a.rb:37
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/is_a.rb:43
  def mocha_inspect; end
end

# Parameter matcher which matches when actual parameter is a kind of specified class.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/kind_of.rb:29
class Mocha::ParameterMatchers::KindOf < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/kind_of.rb:31
  def initialize(klass); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/kind_of.rb:36
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/kind_of.rb:44
  def mocha_inspect; end
end

# Parameter matcher which inverts the logic of the specified matcher using a logical NOT operation.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/not.rb:29
class Mocha::ParameterMatchers::Not < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/not.rb:31
  def initialize(matcher); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/not.rb:36
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/not.rb:42
  def mocha_inspect; end
end

# Parameter matcher which allows optional parameters to be specified.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/optionally.rb:38
class Mocha::ParameterMatchers::Optionally < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/optionally.rb:40
  def initialize(*parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/optionally.rb:45
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/optionally.rb:56
  def mocha_inspect; end
end

# @private
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/positional_or_keyword_hash.rb:9
class Mocha::ParameterMatchers::PositionalOrKeywordHash < ::Mocha::ParameterMatchers::Base
  # pkg:gem/mocha#lib/mocha/parameter_matchers/positional_or_keyword_hash.rb:10
  def initialize(value, expectation); end

  # pkg:gem/mocha#lib/mocha/parameter_matchers/positional_or_keyword_hash.rb:15
  def matches?(available_parameters); end

  # pkg:gem/mocha#lib/mocha/parameter_matchers/positional_or_keyword_hash.rb:29
  def mocha_inspect; end

  private

  # pkg:gem/mocha#lib/mocha/parameter_matchers/positional_or_keyword_hash.rb:43
  def deprecation_warning(actual, expected); end

  # pkg:gem/mocha#lib/mocha/parameter_matchers/positional_or_keyword_hash.rb:59
  def expectation_definition; end

  # pkg:gem/mocha#lib/mocha/parameter_matchers/positional_or_keyword_hash.rb:35
  def extract_parameter(available_parameters); end

  # pkg:gem/mocha#lib/mocha/parameter_matchers/positional_or_keyword_hash.rb:51
  def hash_type(hash); end

  # pkg:gem/mocha#lib/mocha/parameter_matchers/positional_or_keyword_hash.rb:55
  def ruby2_keywords_hash?(hash); end

  # pkg:gem/mocha#lib/mocha/parameter_matchers/positional_or_keyword_hash.rb:39
...
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/regexp_matches.rb:29
class Mocha::ParameterMatchers::RegexpMatches < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/regexp_matches.rb:31
  def initialize(regexp); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/regexp_matches.rb:36
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/regexp_matches.rb:43
  def mocha_inspect; end
end

# Parameter matcher which matches if actual parameter returns expected result when specified method is invoked.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/responds_with.rb:57
class Mocha::ParameterMatchers::RespondsWith < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/responds_with.rb:59
  def initialize(message, result); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/responds_with.rb:65
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/responds_with.rb:71
  def mocha_inspect; end
end

# Parameter matcher which matches if actual parameter is YAML equivalent of specified object.
#
# pkg:gem/mocha#lib/mocha/parameter_matchers/yaml_equivalent.rb:29
class Mocha::ParameterMatchers::YamlEquivalent < ::Mocha::ParameterMatchers::Base
  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/yaml_equivalent.rb:31
  def initialize(object); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/yaml_equivalent.rb:36
  def matches?(available_parameters); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/parameter_matchers/yaml_equivalent.rb:44
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/parameters_matcher.rb:5
class Mocha::ParametersMatcher
  # pkg:gem/mocha#lib/mocha/parameters_matcher.rb:6
  def initialize(expected_parameters = T.unsafe(nil), expectation = T.unsafe(nil), &matching_block); end

  # pkg:gem/mocha#lib/mocha/parameters_matcher.rb:12
  def match?(actual_parameters = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/parameters_matcher.rb:34
  def matchers; end

  # pkg:gem/mocha#lib/mocha/parameters_matcher.rb:24
  def mocha_inspect; end

  # pkg:gem/mocha#lib/mocha/parameters_matcher.rb:20
  def parameters_match?(actual_parameters); end
end

# pkg:gem/mocha#lib/mocha/ruby_version.rb:2
Mocha::RUBY_V27_PLUS = T.let(T.unsafe(nil), TrueClass)

# pkg:gem/mocha#lib/mocha/ruby_version.rb:3
Mocha::RUBY_V34_PLUS = T.let(T.unsafe(nil), TrueClass)

# pkg:gem/mocha#lib/mocha/raised_exception.rb:2
class Mocha::RaisedException
  # pkg:gem/mocha#lib/mocha/raised_exception.rb:3
  def initialize(exception); end

  # pkg:gem/mocha#lib/mocha/raised_exception.rb:7
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/return_values.rb:4
class Mocha::ReturnValues
  # pkg:gem/mocha#lib/mocha/return_values.rb:11
  def initialize(*values); end

  # pkg:gem/mocha#lib/mocha/return_values.rb:23
  def +(other); end

  # pkg:gem/mocha#lib/mocha/return_values.rb:15
  def next(invocation); end

  # pkg:gem/mocha#lib/mocha/return_values.rb:9
  def values; end
  ...
  class << self
    # pkg:gem/mocha#lib/mocha/return_values.rb:5
...
# @see Expectation#in_sequence
#
# pkg:gem/mocha#lib/mocha/sequence.rb:6
class Mocha::Sequence
  # @private
  #
  # pkg:gem/mocha#lib/mocha/sequence.rb:24
  def initialize(name); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/sequence.rb:30
  def constrain_as_next_in_sequence(expectation); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/sequence.rb:42
  def mocha_inspect; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/sequence.rb:37
  def satisfied_to_index?(index); end
end

# @private
#
# pkg:gem/mocha#lib/mocha/sequence.rb:8
class Mocha::Sequence::InSequenceOrderingConstraint
  # pkg:gem/mocha#lib/mocha/sequence.rb:9
  def initialize(sequence, index); end

  # pkg:gem/mocha#lib/mocha/sequence.rb:14
  def allows_invocation_now?; end

  # pkg:gem/mocha#lib/mocha/sequence.rb:18
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/single_return_value.rb:4
class Mocha::SingleReturnValue
  # pkg:gem/mocha#lib/mocha/single_return_value.rb:5
  def initialize(value); end

  # pkg:gem/mocha#lib/mocha/single_return_value.rb:9
  def evaluate(invocation); end
end
...
#
# pkg:gem/mocha#lib/mocha/state_machine.rb:4
class Mocha::StateMachine
  # @private
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:41
  def initialize(name); end
  ...
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:58
  def become(next_state_name); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:38
  ...
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:76
  ...
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:84
  def is_not(unexpected_state_name); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:89
  def mocha_inspect; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:35
  def name; end
  ...
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:50
...
#
# pkg:gem/mocha#lib/mocha/state_machine.rb:27
class Mocha::StateMachine::State < ::Mocha::StateMachine::StatePredicate
  # @private
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:29
  def activate; end
end

# Provides the ability to determine whether a {StateMachine} is in a specified state at some point in the future.
#
# pkg:gem/mocha#lib/mocha/state_machine.rb:6
class Mocha::StateMachine::StatePredicate
  # @private
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:8
  def initialize(state_machine, state, description, &active_check); end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:16
  def active?; end

  # @private
  #
  # pkg:gem/mocha#lib/mocha/state_machine.rb:21
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/stubbed_method.rb:5
class Mocha::StubbedMethod
  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:10
  def initialize(stubbee, method_name); end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:62
  def ==(_arg0); end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:43
  def define_new_method; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:37
  def hide_original_method; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:57
  def matches?(other); end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:8
  def method_name; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:29
  def mock; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:53
  def remove_new_method; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:33
  def reset_mocha; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:17
  def stub; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:8
  def stubbee; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:64
  def to_s; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:22
  def unstub; end

  private

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:70
  def retain_original_visibility(method_owner); end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:75
  def store_original_method_visibility; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:84
  def stub_method_owner; end

  # pkg:gem/mocha#lib/mocha/stubbed_method.rb:79
  def use_prepended_module_for_stub_method; end
end

# pkg:gem/mocha#lib/mocha/stubbed_method.rb:6
...
#
# pkg:gem/mocha#lib/mocha/stubbing_error.rb:7
class Mocha::StubbingError < ::Mocha::ErrorWithFilteredBacktrace; end

# pkg:gem/mocha#lib/mocha/thrower.rb:2
class Mocha::Thrower
  # pkg:gem/mocha#lib/mocha/thrower.rb:3
  def initialize(tag, object = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/thrower.rb:8
  def evaluate(invocation); end
end

# pkg:gem/mocha#lib/mocha/thrown_object.rb:2
class Mocha::ThrownObject
  # pkg:gem/mocha#lib/mocha/thrown_object.rb:3
  def initialize(tag, value = T.unsafe(nil)); end

  # pkg:gem/mocha#lib/mocha/thrown_object.rb:8
  def mocha_inspect; end
end

# pkg:gem/mocha#lib/mocha/version.rb:2
Mocha::VERSION = T.let(T.unsafe(nil), String)

# pkg:gem/mocha#lib/mocha/yield_parameters.rb:2
class Mocha::YieldParameters
  # pkg:gem/mocha#lib/mocha/yield_parameters.rb:3
  def initialize; end

  # pkg:gem/mocha#lib/mocha/yield_parameters.rb:15
  def add(*parameter_groups); end

  # pkg:gem/mocha#lib/mocha/yield_parameters.rb:7
  def next_invocation; end
end

# pkg:gem/mocha#lib/mocha/parameter_matchers/instance_methods.rb:24
...
# pkg:gem/mocha#lib/mocha/inspect.rb:64
class Time
  include ::Comparable
