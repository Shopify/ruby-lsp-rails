...
# @abstract It cannot be directly instantiated. Subclasses must implement the `abstract` methods below.
#
# source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#6
class RubyLsp::Addon::ProcessClient
  abstract!

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#34
  sig { params(addon: ::RubyLsp::Addon, command: ::String).void }
  def initialize(addon, command); end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#19
  sig { returns(::RubyLsp::Addon) }
  def addon; end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#99
  sig { params(message: ::String).void }
  def log_output(message); end

  # Notifications are like messages, but one-way, with no response sent back.
  #
  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#105
  sig { params(request: ::String, params: T.nilable(T::Hash[::Symbol, T.untyped])).void }
  def send_notification(request, params = T.unsafe(nil)); end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#83
  sig { void }
  def shutdown; end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#28
  sig { returns(::IO) }
  def stderr; end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#22
  sig { returns(::IO) }
  def stdin; end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#25
  sig { returns(::IO) }
  def stdout; end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#94
  sig { returns(T::Boolean) }
  def stopped?; end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#31
  sig { returns(::Process::Waiter) }
  def wait_thread; end

  private

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#159
  sig { void }
  def force_kill; end

  # @abstract
  #
  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#168
  sig { abstract.params(response: T::Hash[::Symbol, T.untyped]).void }
  def handle_initialize_response(response); end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#115
  sig do
    params(
      request: ::String,
  ...
  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#134
  sig { overridable.returns(T.nilable(T::Hash[::Symbol, T.untyped])) }
  def read_response; end

  # @abstract
  #
  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#165
  sig { abstract.void }
  def register_exit_handler; end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#121
...
# source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#9
class RubyLsp::Addon::ProcessClient::EmptyMessageError < ::StandardError; end

# source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#8
class RubyLsp::Addon::ProcessClient::IncompleteMessageError < ::StandardError; end

# source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#7
class RubyLsp::Addon::ProcessClient::InitializationError < ::StandardError; end

# source://ruby-lsp/lib/ruby_lsp/addon/process_client.rb#11
RubyLsp::Addon::ProcessClient::MAX_RETRIES = T.let(T.unsafe(nil), Integer)

# @abstract It cannot be directly instantiated. Subclasses must implement the `abstract` methods below.
#
# source://ruby-lsp/lib/ruby_lsp/addon/process_server.rb#6
class RubyLsp::Addon::ProcessServer
  abstract!

  # source://ruby-lsp/lib/ruby_lsp/addon/process_server.rb#15
  sig { void }
  def initialize; end

  # @abstract
  #
  # source://ruby-lsp/lib/ruby_lsp/addon/process_server.rb#45
  sig { abstract.params(request: ::String, params: T.untyped).returns(T.untyped) }
  def execute(request, params); end

  # @abstract
  #
  # source://ruby-lsp/lib/ruby_lsp/addon/process_server.rb#42
  sig { abstract.returns(::String) }
  def generate_initialize_response; end

  # source://ruby-lsp/lib/ruby_lsp/addon/process_server.rb#24
  sig { void }
  def start; end
end

# source://ruby-lsp/lib/ruby_lsp/addon/process_server.rb#12
RubyLsp::Addon::ProcessServer::VOID = T.let(T.unsafe(nil), Object)
